...
class MutualAuthenticator
{
  ...
  initiate()
  {
    ...
    debug('[A] Expected reply is', this.state.expected);
  ...
  mutual_challenge(challenge)
  {
    ...
    debug('[B] Reply is', reply);
    this.state.expected = this.mutate(reply);
    debug('[B] Expected reply to that is', this.state.expected);
  ...
  final_reply(mutual_challenge)
  {
    ...
    debug('[A] Mutual challenge is', decrypted);
    ...
    debug('[A] Final proof is', mutated);
  ...
  consume_final(message)
  {
    ...
    debug('[B] Final proof is', decrypted);
