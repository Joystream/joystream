 ...
 */
function create_server(substrate, config, storage_callbacks)
{
...
function synchronize(config, substrate, dht, storage_callbacks)
{
  // Parse period
  // FIXME const period = flags['syncPeriod'] || config.get('syncPeriod') || 30000;
