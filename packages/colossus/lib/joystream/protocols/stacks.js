...
/*
 * Simplest handler for piped strean errors
 */
...
{
  options = options || {};
  options.error_handler = options.error_handler || default_error_handler;
  ...
  ser.on('error', options.error_handler);
  des.on('error', options.error_handler);
