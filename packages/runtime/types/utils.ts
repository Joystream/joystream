...
import { registerMediaTypes } from '@joystream/runtime/types/media';
import { registerMembershipTypes } from '@joystream/runtime/types/members';
import { registerRolesTypes } from '@joystream/runtime/types/roles';
