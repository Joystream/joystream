...
import { registerMediaTypes } from '@joystream/runtime-api/types/media';
import { registerMembershipTypes } from '@joystream/runtime-api/types/members';
import { registerRolesTypes } from '@joystream/runtime-api/types/roles';
