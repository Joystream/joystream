...
import { OpeningCacheItems } from './transport.substrate'
...
export interface ITransport {
  ...
  groupOpening: (group: WorkingGroups, id: number, openingsCache: OpeningCacheItems) => Promise<WorkingGroupOpening>
