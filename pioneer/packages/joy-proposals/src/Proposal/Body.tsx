...
import { ProposalType, ParsedProposalDetails, SpecificProposalDetails, RuntimeUpgradeProposalDetails } from '@joystream/js/types/proposals';
import { bytesToString } from '@joystream/js/functions/misc';
