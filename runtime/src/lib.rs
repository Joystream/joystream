...
parameter_types! {
    ...
    pub const VoteStageDuration: BlockNumber = 28800;
    pub const RevealStageDuration: BlockNumber = 14400;
    pub const MinimumVotingStake: u64 = 10000;

    // council parameteres
    pub const MinNumberOfExtraCandidates: u64 = 3;
    pub const AnnouncingPeriodDuration: BlockNumber = 57600;
    pub const IdlePeriodDuration: BlockNumber = 100800;
