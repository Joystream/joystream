...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn validate_unsigned_and_then_heartbeat(k: u32, e: u32, ) -> Weight {
		...
		// Minimum execution time: 151_479 nanoseconds.
		Weight::from_ref_time(106_415_209)
			.saturating_add(Weight::from_proof_size(10345712))
			// Standard Error: 408
			.saturating_add(Weight::from_ref_time(51_073).saturating_mul(k.into()))
			// Standard Error: 4_112
			.saturating_add(Weight::from_ref_time(582_904).saturating_mul(e.into()))
