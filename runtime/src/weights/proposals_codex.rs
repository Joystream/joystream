...
impl proposals_codex::WeightInfo for WeightInfo {
    ...
    fn create_proposal_signal(i: u32, _t: u32, d: u32) -> Weight {
        (0 as Weight)
    ...
    // WARNING! Some components were not used: ["t"]
    fn create_proposal_lock_blog_post(_t: u32, d: u32) -> Weight {
    ...
    // WARNING! Some components were not used: ["t"]
    fn create_proposal_withdraw_bounty_funding(_t: u32, d: u32) -> Weight {
