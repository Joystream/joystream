...
const sync = require('joystream/sync');

describe('sync', function()
{
  it('sqeeez', function()
  {
    const seed1 = '0xdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeef';
    const seed2 = '0xdeadd00ddeadd00ddeadd00ddeadd00ddeadd00ddeadd00ddeadd00ddeadd00d';
    const server = sync.create_server(null, { seed: seed1 });
