 ...
 *  Event parameters: []
 */
export class ProposalsDiscussion_ThreadCreatedEvent_V1001 {
 ...
 *  Event parameters: []
 */
export class ProposalsDiscussion_PostCreatedEvent_V1001 {
  public readonly expectedParamTypes = [];
 ...
 *  Event parameters: []
 */
export class ProposalsDiscussion_PostUpdatedEvent_V1001 {
  public readonly expectedParamTypes = [];
 ...
 *  Event parameters: []
 */
export class ProposalsDiscussion_ThreadModeChangedEvent_V1001 {
  public readonly expectedParamTypes = [];
 ...
 *  Event parameters: []
 */
export class ProposalsDiscussion_PostDeletedEvent_V1001 {
  public readonly expectedParamTypes = [];
