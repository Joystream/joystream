...
export interface PalletMembershipRawEvent extends Enum {
  ...
  readonly asMemberInvited: ITuple<
    [u64, PalletMembershipInviteMembershipParameters, u128]
  >;
  readonly isMembershipGifted: boolean;
  readonly asMembershipGifted: ITuple<
    [u64, PalletMembershipGiftMembershipParameters]
  >;
  readonly isMembershipBought: boolean;
  readonly asMembershipBought: ITuple<
    [u64, PalletMembershipBuyMembershipParameters, u32]
  >;
  ...
  readonly asMemberAccountsUpdated: ITuple<
  ...
  readonly asMemberRemarked: ITuple<
    [u64, Bytes, Option<ITuple<[AccountId32, u128]>>]
  >;
  readonly isMemberCreated: boolean;
  readonly asMemberCreated: ITuple<
    [u64, PalletMembershipCreateMemberParameters, u32]
  >;
  readonly type:
    | "MemberInvited"
    | "MembershipGifted"
...
export interface PalletForumRawEvent extends Enum {
  ...
  readonly asCategoryArchivalStatusUpdated: ITuple<
    [u64, bool, PalletForumPrivilegedActor]
  >;
  readonly isCategoryTitleUpdated: boolean;
  readonly asCategoryTitleUpdated: ITuple<
    [u64, H256, PalletForumPrivilegedActor]
  >;
  readonly isCategoryDescriptionUpdated: boolean;
  readonly asCategoryDescriptionUpdated: ITuple<
    [u64, H256, PalletForumPrivilegedActor]
  >;
  ...
  readonly asThreadModerated: ITuple<
    [u64, Bytes, PalletForumPrivilegedActor, u64]
  >;
  readonly isThreadUpdated: boolean;
  readonly asThreadUpdated: ITuple<
    [u64, bool, PalletForumPrivilegedActor, u64]
  >;
  ...
  readonly asPostModerated: ITuple<
    [u64, Bytes, PalletForumPrivilegedActor, u64, u64]
  >;
  readonly isPostDeleted: boolean;
  readonly asPostDeleted: ITuple<
    [Bytes, u64, BTreeMap<PalletForumExtendedPostIdObject, bool>]
  >;
  ...
  readonly asCategoryStickyThreadUpdate: ITuple<
    [u64, BTreeSet<u64>, PalletForumPrivilegedActor]
  >;
...
export interface PalletBountyRawEvent extends Enum {
  ...
  readonly asBountyCreated: ITuple<
    [u64, PalletBountyBountyParametersBTreeSet, Bytes]
  >;
  ...
  readonly asBountyCreatorCherryWithdrawal: ITuple<
    [u64, PalletBountyBountyActor]
  >;
  readonly isBountyCreatorOracleRewardWithdrawal: boolean;
  readonly asBountyCreatorOracleRewardWithdrawal: ITuple<
    [u64, PalletBountyBountyActor]
  >;
  readonly isBountyOracleRewardWithdrawal: boolean;
  readonly asBountyOracleRewardWithdrawal: ITuple<
    [u64, PalletBountyBountyActor, u128]
  >;
  ...
  readonly asOracleJudgmentSubmitted: ITuple<
    [
      u64,
      PalletBountyBountyActor,
      BTreeMap<u64, PalletBountyOracleWorkEntryJudgment>,
      Bytes
    ]
  >;
  ...
  readonly asBountyContributorRemarked: ITuple<
    [PalletBountyBountyActor, u64, Bytes]
  >;
  readonly isBountyOracleRemarked: boolean;
  readonly asBountyOracleRemarked: ITuple<
    [PalletBountyBountyActor, u64, Bytes]
  >;
  ...
  readonly asBountyCreatorRemarked: ITuple<
    [PalletBountyBountyActor, u64, Bytes]
  >;
  ...
  readonly asFunderStateBloatBondWithdrawn: ITuple<
    [u64, PalletBountyBountyActor, u128]
  >;
  readonly isCreatorStateBloatBondWithdrawn: boolean;
  readonly asCreatorStateBloatBondWithdrawn: ITuple<
    [u64, PalletBountyBountyActor, u128]
  >;
  readonly type:
    | "BountyCreated"
...
export interface PalletCommonWorkingGroupIterableEnumsWorkingGroup
  extends Enum {
...
export interface PalletContentRawEvent extends Enum {
  ...
  readonly asCuratorAdded: ITuple<
  ...
  readonly asVideoDeletedByModerator: ITuple<
    [PalletContentPermissionsContentActor, u64, Bytes]
  >;
  readonly isVideoVisibilitySetByModerator: boolean;
  readonly asVideoVisibilitySetByModerator: ITuple<
    [PalletContentPermissionsContentActor, u64, bool, Bytes]
  >;
  ...
  readonly asAuctionCanceled: ITuple<
    [PalletContentPermissionsContentActor, u64]
  >;
  ...
  readonly asNftSellOrderMade: ITuple<
  ...
  readonly asChannelAgentRemarked: ITuple<
    [PalletContentPermissionsContentActor, u64, Bytes]
  >;
  readonly isNftOwnerRemarked: boolean;
  readonly asNftOwnerRemarked: ITuple<
    [PalletContentPermissionsContentActor, u64, Bytes]
  >;
  ...
  readonly asCancelChannelTransfer: ITuple<
    [u64, PalletContentPermissionsContentActor]
  >;
  readonly isChannelTransferAccepted: boolean;
  readonly asChannelTransferAccepted: ITuple<
  ...
  readonly asCreatorTokenIssued: ITuple<
    [PalletContentPermissionsContentActor, u64, u64]
  >;
  readonly type:
    | "CuratorGroupCreated"
...
export interface PalletContentChannelRecord extends Struct {
  ...
  readonly collaborators: BTreeMap<
    u64,
...
export interface PalletContentIterableEnumsChannelActionPermission
  extends Enum {
...
export interface PalletContentPermissionsCuratorGroupIterableEnumsPausableChannelFeature
  extends Enum {
...
export interface PalletContentTransferCommitmentParametersBoundedBTreeMap
  extends Struct {
  readonly newCollaborators: BTreeMap<
    u64,
    BTreeSet<PalletContentIterableEnumsChannelActionPermission>
  >;
  readonly price: u128;
...
export interface PalletContentNftTypesEnglishAuctionParamsRecord
  extends Struct {
...
export interface PalletContentNftTypesNftIssuanceParametersRecord
  extends Struct {
...
export interface PalletContentNftTypesInitTransactionalStatusRecord
  extends Enum {
...
export interface PalletContentPermissionsCuratorGroupIterableEnumsContentModerationAction
  extends Enum {
...
export interface PalletContentTransferCommitmentParametersBTreeMap
  extends Struct {
  readonly newCollaborators: BTreeMap<
    u64,
    BTreeSet<PalletContentIterableEnumsChannelActionPermission>
...
export interface PalletContentUpdateChannelPayoutsParametersRecord
  extends Struct {
...
export interface PalletContentChannelPayoutsPayloadParametersRecord
  extends Struct {
...
export interface PalletStorageRawEvent extends Enum {
  ...
  readonly asStorageBucketsUpdatedForBag: ITuple<
    [PalletStorageBagIdType, BTreeSet<u64>, BTreeSet<u64>]
  >;
  readonly isDataObjectsUploaded: boolean;
  readonly asDataObjectsUploaded: ITuple<
    [BTreeSet<u64>, PalletStorageUploadParametersRecord, u128]
  >;
  ...
  readonly asPendingDataObjectsAccepted: ITuple<
  ...
  readonly asDataObjectsMoved: ITuple<
    [PalletStorageBagIdType, PalletStorageBagIdType, BTreeSet<u64>]
  >;
  readonly isDataObjectsDeleted: boolean;
  readonly asDataObjectsDeleted: ITuple<
    [AccountId32, PalletStorageBagIdType, BTreeSet<u64>]
  >;
  ...
  readonly asDynamicBagCreated: ITuple<
    [PalletStorageDynBagCreationParametersRecord, BTreeSet<u64>]
  >;
  ...
  readonly asNumberOfStorageBucketsInDynamicBagCreationPolicyUpdated: ITuple<
  ...
  readonly asDistributionBucketsUpdatedForBag: ITuple<
  ...
  readonly asDataObjectsUpdated: ITuple<
    [PalletStorageUploadParametersRecord, BTreeSet<u64>, BTreeSet<u64>]
  >;
  ...
  readonly asDistributionOperatorRemarked: ITuple<
    [u64, PalletStorageDistributionBucketIdRecord, Bytes]
  >;
  readonly type:
...
export interface PalletProjectTokenEventsRawEvent extends Enum {
  ...
  readonly asTokenAmountTransferred: ITuple<
    [
      u64,
      u64,
      BTreeMap<PalletProjectTokenValidated, PalletProjectTokenValidatedPayment>,
      Bytes
    ]
  >;
  readonly isTokenAmountTransferredByIssuer: boolean;
  readonly asTokenAmountTransferredByIssuer: ITuple<
    [
      u64,
      u64,
      BTreeMap<PalletProjectTokenValidated, PalletProjectTokenValidatedPayment>,
  ...
  readonly asMemberJoinedWhitelist: ITuple<
    [u64, u64, PalletProjectTokenTransferPolicy]
  >;
  readonly isAccountDustedBy: boolean;
  readonly asAccountDustedBy: ITuple<
    [u64, u64, AccountId32, PalletProjectTokenTransferPolicy]
  >;
  readonly isTokenDeissued: boolean;
  readonly asTokenDeissued: u64;
  readonly isTokenIssued: boolean;
  readonly asTokenIssued: ITuple<
    [u64, PalletProjectTokenTokenIssuanceParameters]
  >;
  readonly isTokenSaleInitialized: boolean;
  readonly asTokenSaleInitialized: ITuple<
    [u64, u32, PalletProjectTokenTokenSale, Option<Bytes>]
  >;
  readonly isUpcomingTokenSaleUpdated: boolean;
  readonly asUpcomingTokenSaleUpdated: ITuple<
    [u64, u32, Option<u32>, Option<u32>]
  >;
...
export interface PalletProposalsEngineRawEvent extends Enum {
  ...
  readonly asProposalStatusUpdated: ITuple<
    [u32, PalletProposalsEngineProposalStatusesProposalStatus]
  >;
  readonly isProposalDecisionMade: boolean;
  readonly asProposalDecisionMade: ITuple<
    [u32, PalletProposalsEngineProposalStatusesProposalDecision]
  >;
  readonly isProposalExecuted: boolean;
  readonly asProposalExecuted: ITuple<
    [u32, PalletProposalsEngineProposalStatusesExecutionStatus]
  >;
...
export interface PalletProposalsEngineProposalStatusesProposalStatus
  extends Enum {
...
export interface PalletProposalsEngineProposalStatusesProposalDecision
  extends Enum {
...
export interface PalletProposalsEngineProposalStatusesApprovedProposalDecision
  extends Enum {
  readonly isPendingExecution: boolean;
  readonly isPendingConstitutionality: boolean;
...
export interface PalletProposalsEngineProposalStatusesExecutionStatus
  extends Enum {
...
export interface PalletProposalsDiscussionRawEvent extends Enum {
  ...
  readonly asThreadModeChanged: ITuple<
    [u64, PalletProposalsDiscussionThreadModeBTreeSet, u64]
  >;
  readonly isPostDeleted: boolean;
...
export interface PalletProposalsCodexProposalDetails extends Enum {
  ...
  readonly asDecreaseWorkingGroupLeadStake: ITuple<
    [u64, u128, PalletCommonWorkingGroupIterableEnumsWorkingGroup]
  >;
  readonly isSlashWorkingGroupLead: boolean;
  readonly asSlashWorkingGroupLead: ITuple<
    [u64, u128, PalletCommonWorkingGroupIterableEnumsWorkingGroup]
  >;
  readonly isSetWorkingGroupLeadReward: boolean;
  readonly asSetWorkingGroupLeadReward: ITuple<
    [u64, Option<u128>, PalletCommonWorkingGroupIterableEnumsWorkingGroup]
  >;
  ...
  readonly asCancelWorkingGroupLeadOpening: ITuple<
    [u64, PalletCommonWorkingGroupIterableEnumsWorkingGroup]
  >;
...
export interface PalletWorkingGroupRawEventInstance1 extends Enum {
  ...
  readonly asAppliedOnOpening: ITuple<
    [PalletWorkingGroupApplyOnOpeningParams, u64]
  >;
  ...
  readonly asRewardPaid: ITuple<
    [u64, AccountId32, u128, PalletWorkingGroupRewardPaymentType]
  >;
...
export interface JoystreamNodeRuntimeNposSolution16 extends Struct {
  ...
  readonly votes3: Vec<
    ITuple<
      [Compact<u32>, Vec<ITuple<[Compact<u16>, Compact<PerU16>]>>, Compact<u16>]
    >
  >;
  readonly votes4: Vec<
    ITuple<
...
/** @name PalletProjectTokenTransfersPaymentWithVesting (391) */
export interface PalletProjectTokenTransfersPaymentWithVesting
  extends BTreeMap<u64, PalletProjectTokenPaymentWithVesting> {}
...
/** @name PalletProjectTokenTransfersPayment (397) */
export interface PalletProjectTokenTransfersPayment
  extends BTreeMap<u64, PalletProjectTokenPayment> {}

/** @name PalletProjectTokenPayment (398) */
export interface PalletProjectTokenPayment extends Struct {
  readonly amount: u128;
}

/** @name PalletProjectTokenMerkleProof (402) */
export interface PalletProjectTokenMerkleProof
  extends Vec<ITuple<[H256, PalletProjectTokenMerkleSide]>> {}
...
export interface PalletContentPermissionsCuratorGroupCuratorGroupRecord
  extends Struct {
  readonly curators: BTreeMap<
    u64,
    BTreeSet<PalletContentIterableEnumsChannelActionPermission>
  >;
...
export interface PalletProjectTokenAccountData extends Struct {
  readonly vestingSchedules: BTreeMap<
...
export interface PalletProposalsDiscussionThreadModeBoundedBTreeSet
  extends Enum {
  readonly isOpen: boolean;
  readonly isClosed: boolean;
  readonly asClosed: BTreeSet<u64>;
