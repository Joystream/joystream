...
> {
    ...
    let light_deps = crate::node_rpc::LightDeps {
    ...
    let rpc_extensions = crate::node_rpc::create_light(light_deps);
...
mod tests {
    ...
    use node_runtime::constants::{currency::CENTS, SLOT_DURATION};
        ...
        sc_service_test::sync(
            ...
            |service, &mut (ref inherent_data_providers, (ref mut block_import, ref babe_link))| {
                ...
                let babe_pre_digest = loop {
                    inherent_data
                        .replace_data(sp_timestamp::INHERENT_IDENTIFIER, &(slot * SLOT_DURATION));
