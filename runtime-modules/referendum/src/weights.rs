...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn reveal_vote_space_for_new_winner(i: u32, ) -> Weight {
		(93_902_000 as Weight)
			// Standard Error: 125_000
			.saturating_add((2_527_000 as Weight).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().reads(4 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	// Storage: Instance1Referendum Stage (r:1 w:1)
	...
	fn reveal_vote_space_not_in_winners(i: u32, ) -> Weight {
		(98_643_000 as Weight)
			// Standard Error: 288_000
			.saturating_add((1_177_000 as Weight).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().reads(4 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	// Storage: Instance1Referendum Stage (r:1 w:1)
	...
	fn reveal_vote_space_replace_last_winner(i: u32, ) -> Weight {
		(97_034_000 as Weight)
			// Standard Error: 165_000
			.saturating_add((1_642_000 as Weight).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().reads(4 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	// Storage: Instance1Referendum Stage (r:1 w:1)
	...
	fn reveal_vote_already_existing(i: u32, ) -> Weight {
		(96_457_000 as Weight)
			// Standard Error: 333_000
			.saturating_add((2_197_000 as Weight).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().reads(4 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	// Storage: Instance1Referendum Votes (r:1 w:1)
