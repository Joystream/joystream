...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn on_initialize_revealing(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(31_158_714)
			.saturating_add(Weight::from_proof_size(1092))
			// Standard Error: 16_421
			.saturating_add(Weight::from_ref_time(643_219).saturating_mul(i.into()))
	...
	fn vote() -> Weight {
		...
		//  Measured:  `323`
		//  Estimated: `12077`
		// Minimum execution time: 49_579 nanoseconds.
		Weight::from_ref_time(50_307_000)
	...
	fn reveal_vote_space_for_new_winner(i: u32, ) -> Weight {
		...
		//  Estimated: `6316`
		// Minimum execution time: 51_454 nanoseconds.
		Weight::from_ref_time(53_232_130)
			.saturating_add(Weight::from_proof_size(6316))
			// Standard Error: 34_348
			.saturating_add(Weight::from_ref_time(1_682_771).saturating_mul(i.into()))
	...
	fn reveal_vote_space_not_in_winners(i: u32, ) -> Weight {
		...
		//  Measured:  `886 + i * (93 ±0)`
		//  Estimated: `6316`
		// Minimum execution time: 52_998 nanoseconds.
		Weight::from_ref_time(54_295_859)
			.saturating_add(Weight::from_proof_size(6316))
			// Standard Error: 26_588
			.saturating_add(Weight::from_ref_time(1_037_309).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	// Storage: Instance1Referendum Stage (r:1 w:1)
	...
	fn reveal_vote_space_replace_last_winner(i: u32, ) -> Weight {
		...
		//  Measured:  `886 + i * (93 ±0)`
		//  Estimated: `6316`
		// Minimum execution time: 53_329 nanoseconds.
		Weight::from_ref_time(54_740_456)
			.saturating_add(Weight::from_proof_size(6316))
			// Standard Error: 33_066
			.saturating_add(Weight::from_ref_time(805_829).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	// Storage: Instance1Referendum Stage (r:1 w:1)
	...
	fn reveal_vote_already_existing(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(52_917_166)
			.saturating_add(Weight::from_proof_size(6316))
			// Standard Error: 29_527
			.saturating_add(Weight::from_ref_time(1_864_048).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	// Storage: Instance1Referendum Votes (r:1 w:1)
	...
	fn release_vote_stake() -> Weight {
		...
		//  Measured:  `846`
		//  Estimated: `9468`
		// Minimum execution time: 53_358 nanoseconds.
		Weight::from_ref_time(53_945_000)
	...
	fn opt_out_of_voting() -> Weight {
		...
		//  Measured:  `72`
		//  Estimated: `2523`
		// Minimum execution time: 18_151 nanoseconds.
		Weight::from_ref_time(18_848_000)
