...
pub struct Class<CuratorGroupId: Ord, ClassId, EntityId: Default + BaseArithmetic> {
...
impl<CuratorGroupId: Ord, ClassId, EntityId: Default + BaseArithmetic> Default
    for Class<CuratorGroupId, ClassId, EntityId>
{
    fn default() -> Self {
        Self {
            class_permissions: ClassPermissions::<CuratorGroupId>::default(),
            properties: vec![],
            schemas: vec![],
            name: vec![],
            description: vec![],
            maximum_entities_count: EntityId::default(),
            current_number_of_entities: EntityId::default(),
            default_entity_creation_voucher_upper_bound: EntityId::default(),
        }
    }
}

impl<CuratorGroupId: Ord, ClassId, EntityId: Default + BaseArithmetic>
    Class<CuratorGroupId, ClassId, EntityId>
{
