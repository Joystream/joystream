        ...
        match actual_result {
            Ok(()) => {
                if post.author == self.actor.clone()
                    || VideoPostType::<Test>::Description == post.post_type
                {
...
pub fn create_default_curator_owned_channel_with_video_and_post(
    ...
    create_default_curator_owned_channel_with_video(deletion_prize, permissions);
...
pub fn create_default_curator_owned_channel_with_video_and_comment(
    ...
    create_default_curator_owned_channel_with_video_and_post(deletion_prize, permissions);
