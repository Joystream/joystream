...
/////////////////////////////////////////////////////////////////////
//// Channel agent / owner permissions - ManageChannelModerators ////
/////////////////////////////////////////////////////////////////////

// Curator channels

#[test]
fn unsuccessful_channel_moderators_update_by_curator_agent_without_permissions() {
    with_default_mock_builder(|| {
        ContentTest::with_curator_channel()
            .with_all_agent_permissions_except(&[ChannelActionPermission::ManageChannelModerators])
            .setup();
...
#[test]
fn successful_channel_moderators_update_by_curator_agent() {
    with_default_mock_builder(|| {
        ContentTest::with_curator_channel()
            .with_agent_permissions(&[ChannelActionPermission::ManageChannelModerators])
            .setup();
        UpdateModeratorSetFixture::default()
            .with_sender(DEFAULT_CURATOR_ACCOUNT_ID)
            .with_actor(default_curator_actor())
...
#[test]
fn successful_channel_moderators_update_by_lead() {
    with_default_mock_builder(|| {
        ContentTest::with_curator_channel().setup();
        UpdateModeratorSetFixture::default()
            .with_sender(LEAD_ACCOUNT_ID)
...
#[test]
fn unsuccessful_channel_moderators_update_by_collaborator_without_permissions() {
    with_default_mock_builder(|| {
        ContentTest::with_member_channel()
            .with_all_agent_permissions_except(&[ChannelActionPermission::ManageChannelModerators])
            .setup();
...
#[test]
fn successful_channel_moderators_update_by_collaborator() {
    with_default_mock_builder(|| {
        ContentTest::with_member_channel()
            .with_agent_permissions(&[ChannelActionPermission::ManageChannelModerators])
            .setup();
...
#[test]
fn successful_channel_moderators_update_by_owner_member() {
    with_default_mock_builder(|| {
        ContentTest::with_member_channel().setup();
        UpdateModeratorSetFixture::default()
            .with_sender(DEFAULT_MEMBER_ACCOUNT_ID)
...
/////////////////////////////////////////////////////////////////////
/// Channel agent / owner permissions - UpdateVideoCommentsStatus ///
/////////////////////////////////////////////////////////////////////

// Curator channels

#[test]
fn unsuccessful_video_comments_status_update_by_curator_agent_without_permissions() {
    with_default_mock_builder(|| {
        ContentTest::with_curator_channel()
            .with_video()
            .with_all_agent_permissions_except(&[
                ChannelActionPermission::UpdateVideoCommentsStatus,
            ])
            .setup();
        UpdateVideoFixture::default()
            .with_sender(DEFAULT_CURATOR_ACCOUNT_ID)
            .with_actor(default_curator_actor())
            .with_enable_comments(Some(false))
            .call_and_assert(Err(
                Error::<Test>::ChannelAgentInsufficientPermissions.into()
            ));
    })
...
#[test]
fn successful_video_comments_status_update_by_curator_agent() {
    with_default_mock_builder(|| {
        ContentTest::with_curator_channel()
            .with_video()
            .with_agent_permissions(&[ChannelActionPermission::UpdateVideoCommentsStatus])
            .setup();
        UpdateVideoFixture::default()
            .with_sender(DEFAULT_CURATOR_ACCOUNT_ID)
            .with_actor(default_curator_actor())
...
#[test]
fn successful_video_comments_status_update_by_lead() {
    with_default_mock_builder(|| {
        ContentTest::with_curator_channel().with_video().setup();
        UpdateVideoFixture::default()
            .with_sender(LEAD_ACCOUNT_ID)
...
#[test]
fn unsuccessful_video_comments_status_update_by_collaborator_without_permissions() {
    with_default_mock_builder(|| {
        ContentTest::with_member_channel()
            .with_video()
            .with_all_agent_permissions_except(&[
...
#[test]
fn successful_video_comments_status_update_by_collaborator() {
    with_default_mock_builder(|| {
        ContentTest::with_member_channel()
            .with_video()
            .with_agent_permissions(&[ChannelActionPermission::UpdateVideoCommentsStatus])
...
#[test]
fn successful_video_comments_status_update_by_owner_member() {
    with_default_mock_builder(|| {
        ContentTest::with_member_channel().with_video().setup();
        UpdateVideoFixture::default()
            .with_sender(DEFAULT_MEMBER_ACCOUNT_ID)
...
////////////////////////////////////////////////////////////////////////
//// Channel agent / owner permissions - ManageVideoDescriptionPost ////
////////////////////////////////////////////////////////////////////////

// Curator channels

#[test]
fn unsuccessful_video_description_post_creation_by_curator_agent_without_permissions() {
    with_default_mock_builder(|| {
        ContentTest::with_curator_channel()
            .with_video()
            .with_all_agent_permissions_except(&[
...
#[test]
fn unsuccessful_video_description_post_update_by_curator_agent_without_permissions() {
    with_default_mock_builder(|| {
        ContentTest::with_curator_channel()
            .with_video()
            .with_video_post()
...
#[test]
fn unsuccessful_video_description_post_deletion_by_curator_agent_without_permissions() {
    with_default_mock_builder(|| {
        ContentTest::with_curator_channel()
            .with_video()
            .with_video_post()
...
#[test]
fn successful_video_description_post_management_by_curator_agent() {
    with_default_mock_builder(|| {
        ContentTest::with_curator_channel()
            .with_video()
            .with_agent_permissions(&[ChannelActionPermission::ManageVideoDescriptionPost])
            .setup();
...
#[test]
fn successful_video_description_post_management_by_lead() {
    with_default_mock_builder(|| {
        ContentTest::with_curator_channel().with_video().setup();
        CreatePostFixture::default()
            .with_sender(LEAD_ACCOUNT_ID)
...
#[test]
fn unsuccessful_video_description_post_creation_by_collaborator_without_permissions() {
    with_default_mock_builder(|| {
        ContentTest::with_member_channel()
            .with_video()
            .with_all_agent_permissions_except(&[
...
#[test]
fn unsuccessful_video_description_post_update_by_collaborator_without_permissions() {
    with_default_mock_builder(|| {
        ContentTest::with_member_channel()
            .with_video()
            .with_video_post()
...
#[test]
fn unsuccessful_video_description_post_deletion_by_collaborator_without_permissions() {
    with_default_mock_builder(|| {
        ContentTest::with_member_channel()
            .with_video()
            .with_video_post()
...
#[test]
fn successful_video_description_post_management_by_collaborator() {
    with_default_mock_builder(|| {
        ContentTest::with_member_channel()
            .with_video()
            .with_agent_permissions(&[ChannelActionPermission::ManageVideoDescriptionPost])
...
#[test]
fn successful_video_description_post_management_by_owner_member() {
    with_default_mock_builder(|| {
        ContentTest::with_member_channel()
            .with_video()
            .with_agent_permissions(&[ChannelActionPermission::ManageVideoDescriptionPost])
