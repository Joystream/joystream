...
use crate::{
    ...
    permissions::*,
    types::{
        ChannelAgentPermissions, ChannelOwner, ChannelUpdateParameters, ContentTreasury,
        ModuleAccount, StorageAssets, VideoUpdateParameters,
    },
...
use super::{
    ...
    prepare_worst_case_scenario_video_creation_parameters,
    setup_worst_case_curator_group_with_curators, setup_worst_case_scenario_curator_channel,
    setup_worst_case_scenario_mutable_video, storage_buckets_num_witness,
    ...
    RuntimeConfig, CURATOR_IDS, MAX_AUCTION_WHITELIST_LENGTH, MAX_BYTES_METADATA,
};
    ...
    update_video_with_assets_without_nft {
        ...
        let params = VideoUpdateParameters::<T> {
            ...
            expected_data_object_state_bloat_bond:
                storage::Pallet::<T>::data_object_state_bloat_bond_value(),
            new_meta: None,
            storage_buckets_num_witness: Some(storage_buckets_num_witness::<T>(channel_id)).transpose()?
        };
        let expected_asset_ids: BTreeSet<T::DataObjectId> = (
