...
pub fn ensure_actor_can_manage_collaborators<T: Config>(
    sender: &T::AccountId,
    owner: &ChannelOwner<T::MemberId, T::CuratorGroupId>,
    actor: &ContentActor<T::CuratorGroupId, T::CuratorId, T::MemberId>,
) -> DispatchResult {
...
pub fn ensure_actor_can_manage_moderators<T: Config>(
    sender: &T::AccountId,
    owner: &ChannelOwner<T::MemberId, T::CuratorGroupId>,
    actor: &ContentActor<T::CuratorGroupId, T::CuratorId, T::MemberId>,
) -> DispatchResult {
...
pub fn ensure_actor_can_manage_reward_account<T: Config>(
    sender: &T::AccountId,
    owner: &ChannelOwner<T::MemberId, T::CuratorGroupId>,
    actor: &ContentActor<T::CuratorGroupId, T::CuratorId, T::MemberId>,
) -> DispatchResult {
...
pub fn ensure_channel_is_owned_by_curators<T: Config>(
    owner: &ChannelOwner<T::MemberId, T::CuratorGroupId>,
) -> DispatchResult {
...
pub fn ensure_actor_authorized_to_update_channel_assets<T: Config>(
    sender: &T::AccountId,
    actor: &ContentActor<T::CuratorGroupId, T::CuratorId, T::MemberId>,
    channel: &Channel<T>,
) -> DispatchResult {
...
pub fn ensure_member_is_collaborator<T: Config>(
    member_id: &T::MemberId,
    channel: &Channel<T>,
) -> DispatchResult {
    ensure!(
...
pub fn ensure_actor_is_channel_owner<T: Config>(
    actor: &ContentActor<T::CuratorGroupId, T::CuratorId, T::MemberId>,
    owner: &ChannelOwner<T::MemberId, T::CuratorGroupId>,
) -> DispatchResult {
...
pub fn ensure_actor_authorized_to_add_comment<T: Config>(
    sender: &T::AccountId,
    actor: &ContentActor<T::CuratorGroupId, T::CuratorId, T::MemberId>,
) -> DispatchResult {
    ensure_actor_auth_success::<T>(sender, actor)
...
pub fn ensure_actor_authorized_to_add_video_post<T: Config>(
    sender: &T::AccountId,
    actor: &ContentActor<T::CuratorGroupId, T::CuratorId, T::MemberId>,
    owner: &ChannelOwner<T::MemberId, T::CuratorGroupId>,
) -> DispatchResult {
...
pub fn ensure_actor_authorized_to_edit_video_post<T: Config>(
    sender: &T::AccountId,
    actor: &ContentActor<T::CuratorGroupId, T::CuratorId, T::MemberId>,
    owner: &ChannelOwner<T::MemberId, T::CuratorGroupId>,
) -> DispatchResult {
...
pub fn ensure_actor_authorized_to_edit_comment<T: Config>(
    sender: &T::AccountId,
    actor: &ContentActor<T::CuratorGroupId, T::CuratorId, T::MemberId>,
    post: &VideoPost<T>,
) -> DispatchResult {
...
pub fn ensure_actor_authorized_to_remove_comment<T: Config>(
    sender: &T::AccountId,
    actor: &ContentActor<T::CuratorGroupId, T::CuratorId, T::MemberId>,
    channel: &Channel<T>,
    post: &VideoPost<T>,
...
// Ensure actor can create post: same rules as if he is trying to update channel
pub fn ensure_actor_authorized_to_remove_video_post<T: Config>(
    sender: &T::AccountId,
    actor: &ContentActor<T::CuratorGroupId, T::CuratorId, T::MemberId>,
    channel: &Channel<T>,
) -> DispatchResult {
...
pub fn ensure_actor_is_moderator<T: Config>(
    actor: &ContentActor<T::CuratorGroupId, T::CuratorId, T::MemberId>,
...
pub fn ensure_actor_is_comment_author<T: Config>(
    actor: &ContentActor<T::CuratorGroupId, T::CuratorId, T::MemberId>,
