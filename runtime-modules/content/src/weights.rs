...
//! DATE: 2022-07-07, STEPS: `5`, REPEAT: 2, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
pub trait WeightInfo {
	fn channel_creation_with_channel_bag(a: u32, b: u32, c: u32, e: u32, f: u32, ) -> Weight;
}

/// Weights for content using the Substrate node and recommended hardware.
pub struct SubstrateWeight<T>(PhantomData<T>);
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	// Storage: unknown [0x2ce461329fdf4be12bce01afc0af09bc13020dc69e85870ac7b4c755bb8753c2] (r:101 w:0)
	...
	// Storage: unknown [0x95875cb80ebaf9f918457db6a86ac6ad33807bc23ee2cb31454339d2b2c6b0a8] (r:20 w:20)
	...
	fn channel_creation_with_channel_bag(a: u32, b: u32, c: u32, _e: u32, f: u32, ) -> Weight {
		(484_190_000 as Weight)
			// Standard Error: 0
			.saturating_add((1_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 383_000
			.saturating_add((7_176_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 381_000
			.saturating_add((3_490_000 as Weight).saturating_mul(c as Weight))
			// Standard Error: 383_000
			.saturating_add((8_365_000 as Weight).saturating_mul(f as Weight))
