...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create_channel(a: u32, b: u32, c: u32, d: u32, e: u32, ) -> Weight {
		(232_015_000 as Weight)
			// Standard Error: 1_523_000
			.saturating_add((13_603_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 161_000
			.saturating_add((18_358_000 as Weight).saturating_mul(c as Weight))
			// Standard Error: 3_025_000
			.saturating_add((18_594_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 0
	...
	fn channel_update_with_assets(a: u32, b: u32, c: u32, d: u32, e: u32, ) -> Weight {
		(391_802_000 as Weight)
			// Standard Error: 2_617_000
			.saturating_add((13_175_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 2_617_000
			.saturating_add((14_275_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 2_617_000
			.saturating_add((14_004_000 as Weight).saturating_mul(c as Weight))
			// Standard Error: 0
			.saturating_add((1_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 1_337_000
			.saturating_add((14_776_000 as Weight).saturating_mul(e as Weight))
	...
	fn channel_update_without_assets(a: u32, b: u32, ) -> Weight {
		(223_105_000 as Weight)
			// Standard Error: 2_576_000
			.saturating_add((10_749_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 0
	...
	fn delete_channel(a: u32, b: u32, ) -> Weight {
		(1_865_943_000 as Weight)
			// Standard Error: 2_508_000
			.saturating_add((4_933_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 1_378_000
			.saturating_add((9_563_000 as Weight).saturating_mul(b as Weight))
	...
	fn delete_channel_assets_as_moderator_with_assets(a: u32, b: u32, c: u32, ) -> Weight {
		(464_937_000 as Weight)
			// Standard Error: 2_568_000
			.saturating_add((2_711_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 1_328_000
			.saturating_add((13_940_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 0
	...
	fn delete_channel_as_moderator(a: u32, b: u32, c: u32, ) -> Weight {
		(1_913_672_000 as Weight)
			// Standard Error: 1_562_000
			.saturating_add((12_815_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 0
			.saturating_add((1_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(108 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(a as Weight)))
	...
	fn delete_video_assets_as_moderator_with_assets(a: u32, b: u32, c: u32, ) -> Weight {
		(415_500_000 as Weight)
			// Standard Error: 1_214_000
			.saturating_add((10_730_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 1_644_000
			.saturating_add((12_383_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 0
			.saturating_add((1_000 as Weight).saturating_mul(c as Weight))
	...
	fn delete_video_as_moderator_with_assets(a: u32, b: u32, c: u32, ) -> Weight {
		(568_279_000 as Weight)
			// Standard Error: 1_427_000
			.saturating_add((8_384_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 1_932_000
			.saturating_add((7_365_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 0
			.saturating_add((1_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(9 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(a as Weight)))
