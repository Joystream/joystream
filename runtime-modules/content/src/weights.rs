...
pub trait WeightInfo {
	...
	fn update_channel(_a: u32, _b: u32, _c: u32, _d: u32, _e: u32, _f: u32, ) -> Weight;
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create_channel(a: u32, b: u32, c: u32, d: u32, e: u32, ) -> Weight {
		(259_810_000 as Weight)
			// Standard Error: 347_000
			.saturating_add((7_217_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 175_000
			.saturating_add((15_467_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 18_000
			.saturating_add((16_071_000 as Weight).saturating_mul(c as Weight))
			// Standard Error: 347_000
			.saturating_add((8_438_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 0
	...
	// Storage: unknown [0x95875cb80ebaf9f918457db6a86ac6ad33807bc23ee2cb31454339d2b2c6b0a8] (r:101 w:101)
	// Storage: unknown [0x26aa394eea5630e07c48ae0c9558cef7b99d880ec681799c0cf30e8886371da9] (r:2 w:2)
	fn update_channel(a: u32, b: u32, c: u32, d: u32, e: u32, f: u32, ) -> Weight {
		(514_873_000 as Weight)
			// Standard Error: 281_000
			.saturating_add((394_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 281_000
			.saturating_add((7_888_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 281_000
			.saturating_add((11_206_000 as Weight).saturating_mul(c as Weight))
			// Standard Error: 0
			.saturating_add((1_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 141_000
			.saturating_add((13_710_000 as Weight).saturating_mul(e as Weight))
			// Standard Error: 14_000
			.saturating_add((11_640_000 as Weight).saturating_mul(f as Weight))
	...
	fn delete_channel(a: u32, b: u32, c: u32, ) -> Weight {
		(381_071_000 as Weight)
			// Standard Error: 293_000
			.saturating_add((11_031_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 151_000
			.saturating_add((13_472_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 17_000
			.saturating_add((11_740_000 as Weight).saturating_mul(c as Weight))
