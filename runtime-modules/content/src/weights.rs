...
//! DATE: 2022-08-05, STEPS: `10`, REPEAT: 5, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create_channel(a: u32, b: u32, c: u32, d: u32, e: u32, ) -> Weight {
		(5_667_423_000 as Weight)
			// Standard Error: 11_451_000
			.saturating_add((21_177_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 1_909_000
			.saturating_add((16_402_000 as Weight).saturating_mul(c as Weight))
			// Standard Error: 21_833_000
			.saturating_add((62_735_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 0
	...
	fn channel_update_with_assets(a: u32, b: u32, c: u32, d: u32, e: u32, f: u32, ) -> Weight {
		(830_705_000 as Weight)
			// Standard Error: 8_324_000
			.saturating_add((14_226_000 as Weight).saturating_mul(c as Weight))
			// Standard Error: 0
			.saturating_add((1_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 4_325_000
			.saturating_add((12_066_000 as Weight).saturating_mul(e as Weight))
			// Standard Error: 726_000
			.saturating_add((8_279_000 as Weight).saturating_mul(f as Weight))
	...
	// Storage: unknown [0xb5a494c92fa4747cc071573e93b32b87af96ab8605611c2e562953c9f5fafe05] (r:1 w:0)
	// Storage: unknown [0x2ce461329fdf4be12bce01afc0af09bc13020dc69e85870ac7b4c755bb8753c2] (r:1 w:0)
	fn channel_update_without_assets(a: u32, b: u32, _c: u32, d: u32, ) -> Weight {
		(396_110_000 as Weight)
			// Standard Error: 3_811_000
			.saturating_add((4_786_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 0
			.saturating_add((1_000 as Weight).saturating_mul(d as Weight))
	...
	fn delete_channel(a: u32, b: u32, c: u32, ) -> Weight {
		(344_992_000 as Weight)
			// Standard Error: 997_000
			.saturating_add((10_182_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 536_000
			.saturating_add((12_496_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 87_000
			.saturating_add((9_453_000 as Weight).saturating_mul(c as Weight))
	...
	fn issue_creator_token(a: u32, ) -> Weight {
		(338_588_000 as Weight)
			// Standard Error: 40_000
			.saturating_add((6_272_000 as Weight).saturating_mul(a as Weight))
	...
	fn creator_token_issuer_transfer(a: u32, b: u32, ) -> Weight {
		(187_342_000 as Weight)
			// Standard Error: 119_000
			.saturating_add((17_484_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 0
