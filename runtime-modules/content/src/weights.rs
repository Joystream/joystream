...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create_channel(a: u32, b: u32, c: u32, d: u32, e: u32, ) -> Weight {
		(47_842_000 as Weight)
			// Standard Error: 862_000
			.saturating_add((6_258_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 434_000
			.saturating_add((14_242_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 45_000
			.saturating_add((12_993_000 as Weight).saturating_mul(c as Weight))
			// Standard Error: 862_000
			.saturating_add((12_070_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 0
	...
	fn channel_update_with_assets(a: u32, b: u32, c: u32, d: u32, e: u32, ) -> Weight {
		(428_605_000 as Weight)
			// Standard Error: 291_000
			.saturating_add((2_069_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 291_000
			.saturating_add((4_020_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 291_000
			.saturating_add((6_488_000 as Weight).saturating_mul(c as Weight))
			// Standard Error: 0
			.saturating_add((1_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 149_000
			.saturating_add((11_678_000 as Weight).saturating_mul(e as Weight))
	...
	fn channel_update_without_assets(a: u32, b: u32, ) -> Weight {
		(182_466_000 as Weight)
			// Standard Error: 155_000
			.saturating_add((9_617_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 0
	...
	fn delete_channel(a: u32, b: u32, c: u32, ) -> Weight {
		(286_082_000 as Weight)
			// Standard Error: 398_000
			.saturating_add((8_624_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 206_000
			.saturating_add((11_732_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 23_000
			.saturating_add((9_395_000 as Weight).saturating_mul(c as Weight))
