...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn funding_request(i: u32, ) -> Weight {
		(18_361_000 as Weight)
			// Standard Error: 10_000
			.saturating_add((68_149_000 as Weight).saturating_mul(i as Weight))
