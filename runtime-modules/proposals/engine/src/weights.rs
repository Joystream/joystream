...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn vote(i: u32, ) -> Weight {
		(64_013_000 as Weight)
			...
			.saturating_add((803_000 as Weight).saturating_mul(i as Weight))
	...
	fn on_initialize_immediate_execution_decode_fails(i: u32, ) -> Weight {
		(58_148_000 as Weight)
			// Standard Error: 315_000
			.saturating_add((62_874_000 as Weight).saturating_mul(i as Weight))
	...
	fn on_initialize_pending_execution_decode_fails(i: u32, ) -> Weight {
		(29_565_000 as Weight)
			// Standard Error: 783_000
			.saturating_add((34_044_000 as Weight).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
	...
	fn on_initialize_approved_pending_constitutionality(i: u32, ) -> Weight {
		(36_321_000 as Weight)
			// Standard Error: 71_000
			.saturating_add((20_778_000 as Weight).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
	...
	fn on_initialize_rejected(i: u32, ) -> Weight {
		(19_638_000 as Weight)
			// Standard Error: 443_000
			.saturating_add((87_933_000 as Weight).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
	...
	fn on_initialize_slashed(i: u32, ) -> Weight {
		(22_103_000 as Weight)
			// Standard Error: 282_000
			.saturating_add((76_629_000 as Weight).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
			.saturating_add(T::DbWeight::get().reads((3 as Weight).saturating_mul(i as Weight)))
			.saturating_add(T::DbWeight::get().writes(2 as Weight))
			.saturating_add(T::DbWeight::get().writes((8 as Weight).saturating_mul(i as Weight)))
	...
	fn cancel_active_and_pending_proposals(i: u32, ) -> Weight {
		(31_476_000 as Weight)
			...
			.saturating_add((50_776_000 as Weight).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
			.saturating_add(T::DbWeight::get().reads((3 as Weight).saturating_mul(i as Weight)))
			.saturating_add(T::DbWeight::get().writes(2 as Weight))
			.saturating_add(T::DbWeight::get().writes((8 as Weight).saturating_mul(i as Weight)))
