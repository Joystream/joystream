...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn transfer(o: u32, m: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((16_605_000 as Weight).saturating_mul(o as Weight))
			// Standard Error: 0
	...
	fn join_whitelist(h: u32, ) -> Weight {
		(82_675_000 as Weight)
			// Standard Error: 24_000
			.saturating_add((887_000 as Weight).saturating_mul(h as Weight))
			.saturating_add(T::DbWeight::get().reads(6 as Weight))
			.saturating_add(T::DbWeight::get().writes(4 as Weight))
	}
	// Storage: Membership MembershipById (r:1 w:0)
