...
pub(crate) struct RandomBucketIdIterator<T: Config, Id: BucketId> {
    // Config marker.
...
impl<T: Config, Id: BucketId> Iterator for RandomBucketIdIterator<T, Id> {
    type Item = Id;
...
impl<T: Config, Id: BucketId> RandomBucketIdIterator<T, Id> {
...
pub(crate) struct SequentialBucketIdIterator<T: Config, Id: BucketId> {
    // Config marker.
    trait_marker: PhantomData<T>,
...
impl<T: Config, Id: BucketId> Iterator for SequentialBucketIdIterator<T, Id> {
    type Item = Id;
...
impl<T: Config, Id: BucketId> SequentialBucketIdIterator<T, Id> {
    // Creates new iterator.
    pub(crate) fn new(next_id: Id) -> Self {
        Self {
