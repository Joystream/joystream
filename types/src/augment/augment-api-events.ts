...
declare module '@polkadot/api-base/types/events' {
  export interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    bounty: {
       ...
       * - new oracle
       **/
      BountyOracleSwitched: AugmentedEvent<
        ApiType,
       ...
       * - bounty oracle
       **/
      BountyTerminated: AugmentedEvent<
        ApiType,
        [u64, PalletBountyBountyActor, PalletBountyBountyActor, PalletBountyBountyActor]
      >
      /**
       ...
       * - rationale
       **/
      OracleJudgmentSubmitted: AugmentedEvent<
        ApiType,
    ...
    content: {
      ...
      ChannelPausedFeaturesUpdatedByModerator: AugmentedEvent<
        ApiType,
        [
          PalletContentPermissionsContentActor,
          u64,
      ...
      >
      ChannelPayoutsUpdated: AugmentedEvent<
        ApiType,
      ...
      ChannelRewardClaimedAndWithdrawn: AugmentedEvent<
        ApiType,
        [PalletContentPermissionsContentActor, u64, u128, PalletContentChannelFundsDestination]
      >
      ...
      CuratorGroupPermissionsUpdated: AugmentedEvent<
        ApiType,
      ...
      EnglishAuctionStarted: AugmentedEvent<
        ApiType,
      ...
      InitializedChannelTransfer: AugmentedEvent<
        ApiType,
      ...
      OpenAuctionStarted: AugmentedEvent<
        ApiType,
      ...
      VideoAssetsDeletedByModerator: AugmentedEvent<
        ApiType,
        [PalletContentPermissionsContentActor, u64, BTreeSet<u64>, bool, Bytes]
      >
      VideoCreated: AugmentedEvent<
        ApiType,
    ...
    joystreamUtility: {
       ...
       **/
      UpdatedWorkingGroupBudget: AugmentedEvent<
        ApiType,
    ...
    projectToken: {
       ...
       * - transfer's metadata
       **/
      TokenAmountTransferred: AugmentedEvent<
        ApiType,
       ...
       * - transfer's metadata
       **/
      TokenAmountTransferredByIssuer: AugmentedEvent<
        ApiType,
        [u64, u64, BTreeMap<PalletProjectTokenValidated, PalletProjectTokenValidatedPayment>, Bytes]
      >
      /**
    ...
    storage: {
       ...
       **/
      DistributionBucketsUpdatedForBag: AugmentedEvent<
        ApiType,
       ...
       **/
      NumberOfStorageBucketsInDynamicBagCreationPolicyUpdated: AugmentedEvent<
        ApiType,
