...
export default {
  ...
  /**
   * Lookup72: pallet_membership::GiftMembershipParameters<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup74: pallet_forum::RawEvent<CategoryId, ModeratorId, ThreadId, PostId, primitive_types::H256, ForumUserId, PostReactionId, pallet_forum::PrivilegedActor<T>, pallet_forum::ExtendedPostIdObject<CategoryId, ThreadId, PostId>, pallet_forum::PollInput<Timestamp>>
   **/
  PalletForumRawEvent: {
    _enum: {
  ...
  /**
   * Lookup75: pallet_forum::PrivilegedActor<T>
   **/
  ...
  /**
   * Lookup76: pallet_forum::ExtendedPostIdObject<CategoryId, ThreadId, PostId>
   **/
  ...
  /**
   * Lookup77: pallet_forum::PollInput<Timestamp>
   **/
