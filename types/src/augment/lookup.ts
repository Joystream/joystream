...
export default {
  ...
  /**
   * Lookup72: pallet_forum::RawEvent<CategoryId, ModeratorId, ThreadId, PostId, primitive_types::H256, ForumUserId, PostReactionId, pallet_forum::PrivilegedActor<T>, pallet_forum::ExtendedPostIdObject<CategoryId, ThreadId, PostId>>
   **/
  PalletForumRawEvent: {
    _enum: {
  ...
  /**
   * Lookup78: pallet_constitution::Event
   **/
  ...
  /**
   * Lookup79: pallet_utility::RawEvent<Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup80: pallet_common::working_group::WorkingGroup
   **/
  ...
  /**
   * Lookup83: pallet_content::permissions::ContentActor<CuratorGroupId, CuratorId, MemberId>
   **/
  ...
  /**
   * Lookup84: pallet_content::types::ChannelRecord<MemberId, CuratorGroupId, Balance, ChannelPrivilegeLevel, DataObjectId, BlockNumber, TokenId, TransferId>
   **/
  ...
  /**
   * Lookup85: pallet_content::types::ChannelOwner<MemberId, CuratorGroupId>
   **/
  ...
  /**
   * Lookup88: pallet_content::types::ChannelActionPermission
   **/
  ...
  /**
   * Lookup93: pallet_content::permissions::curator_group::PausableChannelFeature
   **/
  ...
  /**
   * Lookup95: pallet_content::types::ChannelTransferStatus<MemberId, CuratorGroupId, Balance, TransferId>
   **/
  ...
  /**
   * Lookup96: pallet_content::types::PendingTransfer<MemberId, CuratorGroupId, Balance, TransferId>
   **/
  ...
  /**
   * Lookup97: pallet_content::types::TransferCommitmentParameters<MemberId, Balance, TransferId>
   **/
  ...
  /**
   * Lookup99: pallet_content::types::LimitPerPeriod<BlockNumber>
   **/
  ...
  /**
   * Lookup100: pallet_content::types::NftCounter<BlockNumber>
   **/
  ...
  /**
   * Lookup101: pallet_content::nft::types::EnglishAuctionParamsRecord<BlockNumber, Balance, MemberId>
   **/
  ...
  /**
   * Lookup104: pallet_content::nft::types::OpenAuctionParamsRecord<BlockNumber, Balance, MemberId>
   **/
  ...
  /**
   * Lookup105: pallet_content::nft::types::NftIssuanceParametersRecord<MemberId, pallet_content::nft::types::InitTransactionalStatusRecord<pallet_content::nft::types::EnglishAuctionParamsRecord<BlockNumber, Balance, MemberId>, pallet_content::nft::types::OpenAuctionParamsRecord<BlockNumber, Balance, MemberId>, MemberId, Balance>>
   **/
  ...
  /**
   * Lookup106: pallet_content::nft::types::InitTransactionalStatusRecord<pallet_content::nft::types::EnglishAuctionParamsRecord<BlockNumber, Balance, MemberId>, pallet_content::nft::types::OpenAuctionParamsRecord<BlockNumber, Balance, MemberId>, MemberId, Balance>
   **/
  ...
  /**
   * Lookup108: pallet_content::types::ChannelCreationParametersRecord<pallet_content::types::StorageAssetsRecord<Balance>, MemberId, StorageBucketId, pallet_storage::DistributionBucketIdRecord<DistributionBucketFamilyId, DistributionBucketIndex>, Balance>
   **/
  ...
  /**
   * Lookup109: pallet_content::types::StorageAssetsRecord<Balance>
   **/
  ...
  /**
   * Lookup111: pallet_storage::DataObjectCreationParameters
   **/
  ...
  /**
   * Lookup112: pallet_storage::DistributionBucketIdRecord<DistributionBucketFamilyId, DistributionBucketIndex>
   **/
  ...
  /**
   * Lookup116: pallet_content::types::ChannelUpdateParametersRecord<pallet_content::types::StorageAssetsRecord<Balance>, DataObjectId, MemberId, Balance>
   **/
  ...
  /**
   * Lookup120: pallet_content::types::VideoUpdateParametersRecord<pallet_content::types::StorageAssetsRecord<Balance>, DataObjectId, pallet_content::nft::types::NftIssuanceParametersRecord<MemberId, pallet_content::nft::types::InitTransactionalStatusRecord<pallet_content::nft::types::EnglishAuctionParamsRecord<BlockNumber, Balance, MemberId>, pallet_content::nft::types::OpenAuctionParamsRecord<BlockNumber, Balance, MemberId>, MemberId, Balance>>, Balance>
   **/
  ...
  /**
   * Lookup123: pallet_content::permissions::curator_group::ContentModerationAction
   **/
  ...
  /**
   * Lookup127: pallet_content::types::UpdateChannelPayoutsParametersRecord<pallet_content::types::ChannelPayoutsPayloadParametersRecord<sp_core::crypto::AccountId32, Balance>, Balance, primitive_types::H256>
   **/
  ...
  /**
   * Lookup128: pallet_content::types::ChannelPayoutsPayloadParametersRecord<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup132: pallet_content::types::ChannelFundsDestination<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup135: pallet_storage::UploadParametersRecord<pallet_storage::BagIdType<MemberId, ChannelId>, sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup136: pallet_storage::BagIdType<MemberId, ChannelId>
   **/
  ...
  /**
   * Lookup137: pallet_storage::StaticBagId
   **/
  ...
  /**
   * Lookup138: pallet_storage::DynamicBagIdType<MemberId, ChannelId>
   **/
  ...
  /**
   * Lookup141: pallet_storage::Voucher
   **/
  ...
  /**
   * Lookup147: pallet_project_token::types::TransferPolicy<primitive_types::H256>
   **/
  ...
  /**
   * Lookup149: pallet_project_token::types::TokenAllocation<Balance, pallet_project_token::types::VestingScheduleParams<BlockNumber>>
   **/
  ...
  /**
   * Lookup150: pallet_project_token::types::VestingScheduleParams<BlockNumber>
   **/
  ...
  /**
   * Lookup153: pallet_project_token::types::TransferPolicyParams<pallet_project_token::types::WhitelistParams<primitive_types::H256, pallet_project_token::types::SingleDataObjectUploadParams<JoyBalance>>>
   **/
  ...
  /**
   * Lookup154: pallet_project_token::types::WhitelistParams<primitive_types::H256, pallet_project_token::types::SingleDataObjectUploadParams<JoyBalance>>
   **/
  ...
  /**
   * Lookup155: pallet_project_token::types::SingleDataObjectUploadParams<JoyBalance>
   **/
  ...
  /**
   * Lookup162: pallet_project_token::types::Validated<MemberId>
   **/
  ...
  /**
   * Lookup163: pallet_project_token::types::ValidatedPayment<pallet_project_token::types::PaymentWithVesting<Balance, pallet_project_token::types::VestingScheduleParams<BlockNumber>>>
   **/
  ...
  /**
   * Lookup164: pallet_project_token::types::PaymentWithVesting<Balance, pallet_project_token::types::VestingScheduleParams<BlockNumber>>
   **/
  ...
  /**
   * Lookup166: pallet_project_token::types::VestingSource
   **/
  ...
  /**
   * Lookup170: pallet_project_token::types::TokenSale<JoyBalance, Balance, BlockNumber, pallet_project_token::types::VestingScheduleParams<BlockNumber>, MemberId, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup172: pallet_proposals_engine::RawEvent<ProposalId, MemberId, BlockNumber>
   **/
  ...
  /**
   * Lookup173: pallet_proposals_engine::types::proposal_statuses::ProposalStatus<BlockNumber>
   **/
  ...
  /**
   * Lookup174: pallet_proposals_engine::types::proposal_statuses::ProposalDecision
   **/
  ...
  /**
   * Lookup175: pallet_proposals_engine::types::proposal_statuses::ApprovedProposalDecision
   **/
  PalletProposalsEngineProposalStatusesApprovedProposalDecision: {
    _enum: ['PendingExecution', 'PendingConstitutionality']
  },
  /**
   * Lookup176: pallet_proposals_engine::types::proposal_statuses::ExecutionStatus
   **/
  ...
  /**
   * Lookup177: pallet_proposals_engine::types::VoteKind
   **/
  PalletProposalsEngineVoteKind: {
    _enum: ['Approve', 'Reject', 'Slash', 'Abstain']
  },
  /**
   * Lookup178: pallet_proposals_discussion::RawEvent<ThreadId, MemberId, PostId>
   **/
  ...
  /**
   * Lookup179: pallet_proposals_discussion::types::ThreadMode<MemberId>
   **/
  ...
  /**
   * Lookup180: pallet_proposals_codex::RawEvent<pallet_proposals_codex::types::GeneralProposalParams<MemberId, sp_core::crypto::AccountId32, BlockNumber>, pallet_proposals_codex::types::ProposalDetails<Balance, BlockNumber, sp_core::crypto::AccountId32, WorkerId, OpeningId, ProposalId, pallet_content::types::UpdateChannelPayoutsParametersRecord<pallet_content::types::ChannelPayoutsPayloadParametersRecord<sp_core::crypto::AccountId32, Balance>, Balance, primitive_types::H256>>, ProposalId, ThreadId>
   **/
  ...
  /**
   * Lookup181: pallet_proposals_codex::types::GeneralProposalParams<MemberId, sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup182: pallet_proposals_codex::types::ProposalDetails<Balance, BlockNumber, sp_core::crypto::AccountId32, WorkerId, OpeningId, ProposalId, pallet_content::types::UpdateChannelPayoutsParametersRecord<pallet_content::types::ChannelPayoutsPayloadParametersRecord<sp_core::crypto::AccountId32, Balance>, Balance, primitive_types::H256>>
   **/
  ...
  /**
   * Lookup184: pallet_common::FundingRequestParameters<Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup185: pallet_proposals_codex::types::CreateOpeningParameters<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup186: pallet_working_group::types::StakePolicy<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup187: pallet_proposals_codex::types::FillOpeningParameters
   **/
  ...
  /**
   * Lookup188: pallet_proposals_codex::types::TerminateRoleParameters<WorkerId, Balance>
   **/
  ...
  /**
   * Lookup193: pallet_working_group::types::OpeningType
   **/
  PalletWorkingGroupOpeningType: {
    _enum: ['Leader', 'Regular']
  },
  /**
   * Lookup194: pallet_working_group::types::ApplyOnOpeningParams<MemberId, OpeningId, sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup195: pallet_working_group::types::StakeParameters<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup199: pallet_working_group::Instance2
   **/
  ...
  /**
   * Lookup201: pallet_working_group::Instance3
   **/
  ...
  /**
   * Lookup203: pallet_working_group::Instance4
   **/
  ...
  /**
   * Lookup205: pallet_working_group::Instance5
   **/
  ...
  /**
   * Lookup207: pallet_working_group::Instance6
   **/
  ...
  /**
   * Lookup209: pallet_working_group::Instance7
   **/
  ...
  /**
   * Lookup211: pallet_working_group::Instance8
   **/
  ...
  /**
   * Lookup213: pallet_working_group::Instance9
   **/
  PalletWorkingGroupInstance9: 'Null',
  /**
   * Lookup214: frame_system::Phase
   **/
  FrameSystemPhase: {
    _enum: {
      ApplyExtrinsic: 'u32',
  ...
  /**
   * Lookup221: frame_system::pallet::Call<T>
   **/
  FrameSystemCall: {
    _enum: {
      fill_block: {
  ...
  /**
   * Lookup225: frame_support::weights::PerDispatchClass<frame_system::limits::WeightsPerClass>
   **/
  ...
  /**
   * Lookup229: frame_support::weights::RuntimeDbWeight
   **/
  ...
  /**
   * Lookup236: frame_system::pallet::Error<T>
   **/
  FrameSystemError: {
  ...
  /**
   * Lookup240: pallet_babe::pallet::Call<T>
   **/
  PalletBabeCall: {
    _enum: {
      report_equivocation: {
  ...
  /**
   * Lookup241: sp_consensus_slots::EquivocationProof<sp_runtime::generic::header::Header<Number, sp_runtime::traits::BlakeTwo256>, sp_consensus_babe::app::Public>
   **/
  ...
  /**
   * Lookup242: sp_runtime::generic::header::Header<Number, sp_runtime::traits::BlakeTwo256>
   **/
  SpRuntimeHeader: {
    parentHash: 'H256',
    number: 'Compact<u32>',
  ...
  /**
   * Lookup244: sp_consensus_babe::app::Public
   **/
  SpConsensusBabeAppPublic: 'SpCoreSr25519Public',
  /**
   * Lookup246: sp_session::MembershipProof
   **/
  ...
  /**
   * Lookup247: sp_consensus_babe::digests::NextConfigDescriptor
   **/
  ...
  /**
   * Lookup248: sp_consensus_babe::AllowedSlots
   **/
  SpConsensusBabeAllowedSlots: {
    _enum: ['PrimarySlots', 'PrimaryAndSecondaryPlainSlots', 'PrimaryAndSecondaryVRFSlots']
  },
  /**
   * Lookup249: pallet_timestamp::pallet::Call<T>
   **/
  PalletTimestampCall: {
    _enum: {
      set: {
  ...
  /**
   * Lookup251: pallet_authorship::pallet::Call<T>
   **/
  ...
  /**
   * Lookup255: pallet_election_provider_multi_phase::RawSolution<joystream_node_runtime::NposSolution16>
   **/
  ...
  /**
   * Lookup256: joystream_node_runtime::NposSolution16
   **/
  ...
  /**
   * Lookup307: sp_npos_elections::ElectionScore
   **/
  ...
  /**
   * Lookup315: pallet_staking::pallet::pallet::Call<T>
   **/
  ...
  /**
   * Lookup316: pallet_staking::RewardDestination<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup320: pallet_staking::pallet::pallet::ConfigOp<T>
   **/
  ...
  /**
   * Lookup322: pallet_staking::pallet::pallet::ConfigOp<sp_arithmetic::per_things::Percent>
   **/
  ...
  /**
   * Lookup323: pallet_staking::pallet::pallet::ConfigOp<sp_arithmetic::per_things::Perbill>
   **/
  ...
  /**
   * Lookup324: pallet_session::pallet::Call<T>
   **/
  PalletSessionCall: {
    _enum: {
      set_keys: {
  ...
  /**
   * Lookup325: joystream_node_runtime::SessionKeys
   **/
  ...
  /**
   * Lookup339: pallet_im_online::pallet::Call<T>
   **/
  PalletImOnlineCall: {
    _enum: {
      heartbeat: {
  ...
  /**
   * Lookup340: pallet_im_online::Heartbeat<BlockNumber>
   **/
  ...
  /**
   * Lookup341: sp_core::offchain::OpaqueNetworkState
   **/
  ...
  /**
   * Lookup348: pallet_bags_list::pallet::Call<T, I>
   **/
  PalletBagsListCall: {
    _enum: {
      rebag: {
  ...
  /**
   * Lookup349: pallet_vesting::pallet::Call<T>
   **/
  PalletVestingCall: {
    _enum: {
      vest: 'Null',
  ...
  /**
   * Lookup350: pallet_vesting::vesting_info::VestingInfo<Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup351: pallet_council::Call<T>
   **/
  PalletCouncilCall: {
    _enum: {
      announce_candidacy: {
  ...
  /**
   * Lookup352: pallet_referendum::Call<T, I>
   **/
  ...
  /**
   * Lookup353: pallet_membership::Call<T>
   **/
  ...
  /**
   * Lookup355: pallet_constitution::Call<T>
   **/
  ...
  /**
   * Lookup357: pallet_content::Call<T>
   **/
  PalletContentCall: {
    _enum: {
  ...
  /**
   * Lookup359: pallet_content::types::ProofElementRecord<primitive_types::H256, pallet_content::types::Side>
   **/
  ...
  /**
   * Lookup360: pallet_content::types::Side
   **/
  PalletContentSide: {
    _enum: ['Left', 'Right']
  },
  /**
   * Lookup361: pallet_content::types::PullPaymentElement<ChannelId, Balance, primitive_types::H256>
   **/
  ...
  /**
   * Lookup362: pallet_content::types::InitTransferParameters<MemberId, CuratorGroupId, Balance>
   **/
  ...
  /**
   * Lookup363: pallet_project_token::types::TokenSaleParams<JoyBalance, Balance, BlockNumber, pallet_project_token::types::VestingScheduleParams<BlockNumber>>
   **/
  ...
  /**
   * Lookup364: pallet_project_token::types::Transfers<MemberId, pallet_project_token::types::PaymentWithVesting<Balance, pallet_project_token::types::VestingScheduleParams<BlockNumber>>>
   **/
  PalletProjectTokenTransfersPaymentWithVesting: 'BTreeMap<u64, PalletProjectTokenPaymentWithVesting>',
  /**
   * Lookup368: pallet_storage::Call<T>
   **/
  PalletStorageCall: {
    _enum: {
  ...
  /**
   * Lookup369: pallet_storage::DynBagCreationParametersRecord<pallet_storage::DynamicBagIdType<MemberId, ChannelId>, sp_core::crypto::AccountId32, Balance, StorageBucketId, pallet_storage::DistributionBucketIdRecord<DistributionBucketFamilyId, DistributionBucketIndex>>
   **/
  ...
  /**
   * Lookup370: pallet_project_token::Call<T>
   **/
  ...
  /**
   * Lookup371: pallet_project_token::types::Transfers<MemberId, pallet_project_token::types::Payment<Balance>>
   **/
  PalletProjectTokenTransfersPayment: 'BTreeMap<u64, PalletProjectTokenPayment>',
  /**
   * Lookup372: pallet_project_token::types::Payment<Balance>
   **/
  ...
  /**
   * Lookup376: pallet_project_token::types::MerkleProof<sp_runtime::traits::BlakeTwo256>
   **/
  PalletProjectTokenMerkleProof: 'Vec<(H256,PalletProjectTokenMerkleSide)>',
  /**
   * Lookup379: pallet_project_token::types::MerkleSide
   **/
  PalletProjectTokenMerkleSide: {
    _enum: ['Right', 'Left']
  },
  /**
   * Lookup380: pallet_proposals_engine::Call<T>
   **/
  ...
  /**
   * Lookup381: pallet_proposals_discussion::Call<T>
   **/
  ...
  /**
   * Lookup382: pallet_proposals_codex::Call<T>
   **/
  ...
  /**
   * Lookup383: pallet_working_group::Call<T, I>
   **/
  ...
  /**
   * Lookup392: joystream_node_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup402: sp_consensus_babe::digests::PreDigest
   **/
  ...
  /**
   * Lookup403: sp_consensus_babe::digests::PrimaryPreDigest
   **/
  ...
  /**
   * Lookup404: sp_consensus_babe::digests::SecondaryPlainPreDigest
   **/
  ...
  /**
   * Lookup405: sp_consensus_babe::digests::SecondaryVRFPreDigest
   **/
  ...
  /**
   * Lookup407: sp_consensus_babe::BabeEpochConfiguration
   **/
  ...
  /**
   * Lookup408: pallet_babe::pallet::Error<T>
   **/
  PalletBabeError: {
    _enum: ['InvalidEquivocationProof', 'InvalidKeyOwnershipProof', 'DuplicateOffenceReport', 'InvalidConfiguration']
  },
  /**
   * Lookup410: pallet_authorship::UncleEntryItem<BlockNumber, primitive_types::H256, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup411: pallet_authorship::pallet::Error<T>
   **/
  PalletAuthorshipError: {
    _enum: ['InvalidUncleParent', 'UnclesAlreadySet', 'TooManyUncles', 'GenesisUncle', 'TooHighUncle', 'UncleAlreadyIncluded', 'OldUncle']
  },
  /**
   * Lookup413: pallet_balances::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup414: pallet_balances::Reasons
   **/
  PalletBalancesReasons: {
    _enum: ['Fee', 'Misc', 'All']
  },
  /**
   * Lookup417: pallet_balances::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup419: pallet_balances::Releases
   **/
  ...
  /**
   * Lookup423: pallet_election_provider_multi_phase::Phase<Bn>
   **/
  ...
  /**
   * Lookup425: pallet_election_provider_multi_phase::ReadySolution<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup426: pallet_election_provider_multi_phase::RoundSnapshot<T>
   **/
  ...
  /**
   * Lookup434: pallet_election_provider_multi_phase::signed::SignedSubmission<sp_core::crypto::AccountId32, Balance, joystream_node_runtime::NposSolution16>
   **/
  ...
  /**
   * Lookup435: pallet_election_provider_multi_phase::pallet::Error<T>
   **/
  ...
  /**
   * Lookup436: pallet_staking::StakingLedger<T>
   **/
  ...
  /**
   * Lookup438: pallet_staking::UnlockChunk<Balance>
   **/
  ...
  /**
   * Lookup440: pallet_staking::Nominations<T>
   **/
  ...
  /**
   * Lookup441: pallet_staking::ActiveEraInfo
   **/
  ...
  /**
   * Lookup443: pallet_staking::EraRewardPoints<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup447: pallet_staking::Forcing
   **/
  PalletStakingForcing: {
    _enum: ['NotForcing', 'ForceNew', 'ForceNone', 'ForceAlways']
  },
  /**
   * Lookup449: pallet_staking::UnappliedSlash<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup451: pallet_staking::slashing::SlashingSpans
   **/
  ...
  /**
   * Lookup452: pallet_staking::slashing::SpanRecord<Balance>
   **/
  ...
  /**
   * Lookup455: pallet_staking::Releases
   **/
  PalletStakingReleases: {
    _enum: ['V1_0_0Ancient', 'V2_0_0', 'V3_0_0', 'V4_0_0', 'V5_0_0', 'V6_0_0', 'V7_0_0', 'V8_0_0', 'V9_0_0']
  },
  /**
   * Lookup456: pallet_staking::pallet::pallet::Error<T>
   **/
  ...
  /**
   * Lookup460: sp_core::crypto::KeyTypeId
   **/
  SpCoreCryptoKeyTypeId: '[u8;4]',
  /**
   * Lookup461: pallet_session::pallet::Error<T>
   **/
  PalletSessionError: {
    _enum: ['InvalidProof', 'NoAssociatedValidatorId', 'DuplicatedKey', 'NoKeys', 'NoAccount']
  },
  /**
   * Lookup463: pallet_grandpa::StoredState<N>
   **/
  ...
  /**
   * Lookup464: pallet_grandpa::StoredPendingChange<N, Limit>
   **/
  ...
  /**
   * Lookup466: pallet_grandpa::pallet::Error<T>
   **/
  PalletGrandpaError: {
    _enum: ['PauseFailed', 'ResumeFailed', 'ChangePending', 'TooSoon', 'InvalidKeyOwnershipProof', 'InvalidEquivocationProof', 'DuplicateOffenceReport']
  },
  /**
   * Lookup472: pallet_im_online::BoundedOpaqueNetworkState<PeerIdEncodingLimit, MultiAddrEncodingLimit, AddressesLimit>
   **/
  ...
  /**
   * Lookup476: pallet_im_online::pallet::Error<T>
   **/
  PalletImOnlineError: {
  ...
  /**
   * Lookup481: pallet_bags_list::list::Node<T, I>
   **/
  ...
  /**
   * Lookup482: pallet_bags_list::list::Bag<T, I>
   **/
  ...
  /**
   * Lookup483: pallet_bags_list::pallet::Error<T, I>
   **/
  PalletBagsListError: {
    _enum: {
  ...
  /**
   * Lookup484: pallet_bags_list::list::ListError
   **/
  PalletBagsListListListError: {
    _enum: ['Duplicate', 'NotHeavier', 'NotInSameBag', 'NodeNotFound']
  },
  /**
   * Lookup487: pallet_vesting::Releases
   **/
  PalletVestingReleases: {
    _enum: ['V0', 'V1']
  },
  /**
   * Lookup488: pallet_vesting::pallet::Error<T>
   **/
  PalletVestingError: {
    _enum: ['NotVesting', 'AtMaxVestingSchedules', 'AmountLow', 'ScheduleIndexOutOfBounds', 'InvalidScheduleParams']
  },
  /**
   * Lookup489: pallet_council::CouncilStageUpdate<BlockNumber>
   **/
  ...
  /**
   * Lookup490: pallet_council::CouncilStage
   **/
  ...
  /**
   * Lookup491: pallet_council::CouncilStageAnnouncing
   **/
  PalletCouncilCouncilStageAnnouncing: {
    candidatesCount: 'u64'
  },
  /**
   * Lookup492: pallet_council::CouncilStageElection
   **/
  PalletCouncilCouncilStageElection: {
    candidatesCount: 'u64'
  },
  /**
   * Lookup494: pallet_council::CouncilMember<sp_core::crypto::AccountId32, MemberId, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup495: pallet_council::Candidate<sp_core::crypto::AccountId32, Balance, primitive_types::H256, VotePower>
   **/
  ...
  /**
   * Lookup496: pallet_council::Error<T>
   **/
  PalletCouncilError: {
  ...
  /**
   * Lookup497: pallet_referendum::ReferendumStage<BlockNumber, MemberId, VotePower>
   **/
  ...
  /**
   * Lookup498: pallet_referendum::ReferendumStageVoting<BlockNumber>
   **/
  ...
  /**
   * Lookup499: pallet_referendum::ReferendumStageRevealing<BlockNumber, MemberId, VotePower>
   **/
  ...
  /**
   * Lookup500: pallet_referendum::CastVote<primitive_types::H256, Currency, MemberId>
   **/
  ...
  /**
   * Lookup501: pallet_referendum::Error<T, I>
   **/
  ...
  /**
   * Lookup502: pallet_membership::MembershipObject<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup503: pallet_membership::StakingAccountMemberBinding<MemberId>
   **/
  ...
  /**
   * Lookup504: pallet_membership::Error<T>
   **/
  ...
  /**
   * Lookup505: pallet_forum::Category<CategoryId, ThreadId, primitive_types::H256>
   **/
  PalletForumCategory: {
    titleHash: 'H256',
  ...
  /**
   * Lookup506: pallet_forum::Thread<ForumUserId, CategoryId, Balance>
   **/
  PalletForumThread: {
    categoryId: 'u64',
    authorId: 'u64',
  ...
  /**
   * Lookup507: pallet_forum::Post<ForumUserId, ThreadId, primitive_types::H256, Balance, BlockNumber>
   **/
  PalletForumPost: {
    threadId: 'u64',
    textHash: 'H256',
  ...
  /**
   * Lookup508: pallet_forum::Error<T>
   **/
  PalletForumError: {
  ...
  /**
   * Lookup509: pallet_constitution::ConstitutionInfo
   **/
  ...
  /**
   * Lookup512: pallet_content::nft::types::OwnedNft<pallet_content::nft::types::TransactionalStatusRecord<MemberId, Balance, pallet_content::nft::types::EnglishAuctionRecord<BlockNumber, Balance, MemberId>, pallet_content::nft::types::OpenAuctionRecord<BlockNumber, AuctionId, Balance, MemberId>>, MemberId, AuctionId>
   **/
  ...
  /**
   * Lookup513: pallet_content::nft::types::TransactionalStatusRecord<MemberId, Balance, pallet_content::nft::types::EnglishAuctionRecord<BlockNumber, Balance, MemberId>, pallet_content::nft::types::OpenAuctionRecord<BlockNumber, AuctionId, Balance, MemberId>>
   **/
  ...
  /**
   * Lookup514: pallet_content::nft::types::EnglishAuctionRecord<BlockNumber, Balance, MemberId>
   **/
  ...
  /**
   * Lookup516: pallet_content::nft::types::EnglishAuctionBid<Balance, MemberId>
   **/
  ...
  /**
   * Lookup517: pallet_content::nft::types::OpenAuctionRecord<BlockNumber, AuctionId, Balance, MemberId>
   **/
  ...
  /**
   * Lookup518: pallet_content::nft::types::NftOwner<MemberId>
   **/
  ...
  /**
   * Lookup520: pallet_content::permissions::curator_group::CuratorGroup<T>
   **/
  ...
  /**
   * Lookup521: pallet_content::nft::types::OpenAuctionBidRecord<Balance, BlockNumber, AuctionId>
   **/
  ...
  /**
   * Lookup522: pallet_content::errors::Error<T>
   **/
  ...
  /**
   * Lookup523: pallet_storage::BagRecord<StorageBucketId, pallet_storage::DistributionBucketIdRecord<DistributionBucketFamilyId, DistributionBucketIndex>>
   **/
  ...
  /**
   * Lookup524: pallet_storage::StorageBucketRecord<WorkerId, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup525: pallet_storage::StorageBucketOperatorStatus<WorkerId, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup526: pallet_storage::DynamicBagCreationPolicy<DistributionBucketFamilyId>
   **/
  ...
  /**
   * Lookup528: pallet_storage::DataObject<Balance>
   **/
  ...
  /**
   * Lookup529: pallet_storage::DistributionBucketFamilyRecord<DistributionBucketIndex>
   **/
  PalletStorageDistributionBucketFamilyRecord: {
    nextDistributionBucketIndex: 'u64'
  },
  /**
   * Lookup530: pallet_storage::DistributionBucketRecord<WorkerId>
   **/
  ...
  /**
   * Lookup531: pallet_common::constraints::BoundedValueConstraint<Val>
   **/
  ...
  /**
   * Lookup532: pallet_storage::Error<T>
   **/
  PalletStorageError: {
  ...
  /**
   * Lookup533: pallet_project_token::types::AccountData<pallet_project_token::types::VestingSchedule<BlockNumber, Balance>, Balance, pallet_project_token::types::StakingStatus<Balance>, JoyBalance>
   **/
  ...
  /**
   * Lookup534: pallet_project_token::types::VestingSchedule<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup535: pallet_project_token::types::StakingStatus<Balance>
   **/
  ...
  /**
   * Lookup543: pallet_project_token::types::RevenueSplitState<JoyBalance, BlockNumber>
   **/
  ...
  /**
   * Lookup544: pallet_project_token::types::RevenueSplitInfo<JoyBalance, BlockNumber>
   **/
  ...
  /**
   * Lookup545: pallet_project_token::types::Timeline<BlockNumber>
   **/
  ...
  /**
   * Lookup547: pallet_project_token::types::PatronageData<Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup549: pallet_project_token::errors::Error<T>
   **/
  ...
  /**
   * Lookup550: pallet_proposals_engine::types::Proposal<BlockNumber, ProposerId, Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup551: pallet_proposals_engine::types::ProposalParameters<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup552: pallet_proposals_engine::types::VotingResults
   **/
  ...
  /**
   * Lookup554: pallet_proposals_engine::Error<T>
   **/
  ...
  /**
   * Lookup555: pallet_proposals_discussion::types::DiscussionThread<ThreadAuthorId, BlockNumber, MemberId>
   **/
  ...
  /**
   * Lookup556: pallet_proposals_discussion::types::DiscussionPost<PostAuthorId, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup557: pallet_proposals_discussion::Error<T>
   **/
  ...
  /**
   * Lookup558: pallet_proposals_codex::Error<T>
   **/
  ...
  /**
   * Lookup559: pallet_working_group::types::Opening<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup560: pallet_working_group::types::JobApplication<sp_core::crypto::AccountId32, MemberId>
   **/
  ...
  /**
   * Lookup561: pallet_working_group::types::GroupWorker<sp_core::crypto::AccountId32, MemberId, BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup562: pallet_working_group::errors::Error<T, I>
   **/
  ...
  /**
   * Lookup573: sp_core::ecdsa::Signature
   **/
  ...
  /**
   * Lookup585: joystream_node_runtime::Runtime
   **/
