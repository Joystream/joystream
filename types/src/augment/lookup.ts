...
export default {
  ...
  /**
   * Lookup202: pallet_project_token::types::GovernanceParameters<Balance, BlockNumber, JoyBalance>
   **/
  ...
  /**
   * Lookup205: pallet_proposals_engine::RawEvent<ProposalId, MemberId, BlockNumber>
   **/
  ...
  /**
   * Lookup206: pallet_proposals_engine::types::proposal_statuses::ProposalStatus<BlockNumber>
   **/
  ...
  /**
   * Lookup207: pallet_proposals_engine::types::proposal_statuses::ProposalDecision
   **/
  ...
  /**
   * Lookup208: pallet_proposals_engine::types::proposal_statuses::ApprovedProposalDecision
   **/
  PalletProposalsEngineProposalStatusesApprovedProposalDecision: {
    _enum: ['PendingExecution', 'PendingConstitutionality']
  },
  /**
   * Lookup209: pallet_proposals_engine::types::proposal_statuses::ExecutionStatus
   **/
  ...
  /**
   * Lookup210: pallet_proposals_engine::types::VoteKind
   **/
  PalletProposalsEngineVoteKind: {
    _enum: ['Approve', 'Reject', 'Slash', 'Abstain']
  },
  /**
   * Lookup211: pallet_proposals_discussion::RawEvent<ThreadId, MemberId, PostId>
   **/
  ...
  /**
   * Lookup212: pallet_proposals_discussion::types::ThreadMode<BTreeSet<T>>
   **/
  ...
  /**
   * Lookup213: pallet_proposals_codex::RawEvent<pallet_proposals_codex::types::GeneralProposalParams<MemberId, sp_core::crypto::AccountId32, BlockNumber>, pallet_proposals_codex::types::ProposalDetails<Balance, BlockNumber, sp_core::crypto::AccountId32, WorkerId, OpeningId, ProposalId, pallet_content::types::UpdateChannelPayoutsParametersRecord<pallet_content::types::ChannelPayoutsPayloadParametersRecord<Balance>, Balance, primitive_types::H256>, pallet_project_token::types::GovernanceParameters<Balance, BlockNumber, JoyBalance>>, ProposalId, ThreadId>
   **/
  ...
  /**
   * Lookup214: pallet_proposals_codex::types::GeneralProposalParams<MemberId, sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup217: pallet_common::FundingRequestParameters<Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup218: pallet_proposals_codex::types::CreateOpeningParameters<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup219: pallet_working_group::types::StakePolicy<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup220: pallet_proposals_codex::types::FillOpeningParameters
   **/
  ...
  /**
   * Lookup221: pallet_proposals_codex::types::TerminateRoleParameters<WorkerId, Balance>
   **/
  ...
  /**
   * Lookup222: pallet_common::FreezablePallet
   **/
  ...
  /**
   * Lookup227: pallet_working_group::types::OpeningType
   **/
  PalletWorkingGroupOpeningType: {
    _enum: ['Leader', 'Regular']
  },
  /**
   * Lookup228: pallet_working_group::types::ApplyOnOpeningParams<MemberId, OpeningId, sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup229: pallet_working_group::types::StakeParameters<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup230: pallet_working_group::Instance1
   **/
  PalletWorkingGroupInstance1: 'Null',
  /**
   * Lookup231: pallet_working_group::types::RewardPaymentType
   **/
  ...
  /**
   * Lookup233: pallet_working_group::Instance2
   **/
  ...
  /**
   * Lookup235: pallet_working_group::Instance3
   **/
  ...
  /**
   * Lookup237: pallet_working_group::Instance4
   **/
  ...
  /**
   * Lookup239: pallet_working_group::Instance5
   **/
  ...
  /**
   * Lookup241: pallet_working_group::Instance6
   **/
  ...
  /**
   * Lookup245: pallet_working_group::Instance8
   **/
  ...
  /**
   * Lookup247: pallet_working_group::Instance9
   **/
  PalletWorkingGroupInstance9: 'Null',
  /**
   * Lookup248: frame_system::Phase
   **/
  FrameSystemPhase: {
    _enum: {
      ApplyExtrinsic: 'u32',
  ...
  /**
   * Lookup255: frame_system::pallet::Call<T>
   **/
  FrameSystemCall: {
    _enum: {
      remark: {
  ...
  /**
   * Lookup258: frame_system::limits::BlockWeights
   **/
  ...
  /**
   * Lookup259: frame_support::dispatch::PerDispatchClass<frame_system::limits::WeightsPerClass>
   **/
  ...
  /**
   * Lookup260: frame_system::limits::WeightsPerClass
   **/
  ...
  /**
   * Lookup263: frame_support::dispatch::PerDispatchClass<T>
   **/
  ...
  /**
   * Lookup264: sp_weights::RuntimeDbWeight
   **/
  ...
  /**
   * Lookup265: sp_version::RuntimeVersion
   **/
  ...
  /**
   * Lookup271: frame_system::pallet::Error<T>
   **/
  FrameSystemError: {
  ...
  /**
   * Lookup281: sp_session::MembershipProof
   **/
  ...
  /**
   * Lookup283: sp_consensus_babe::AllowedSlots
   **/
  SpConsensusBabeAllowedSlots: {
    _enum: ['PrimarySlots', 'PrimaryAndSecondaryPlainSlots', 'PrimaryAndSecondaryVRFSlots']
  },
  /**
   * Lookup284: pallet_timestamp::pallet::Call<T>
   **/
  PalletTimestampCall: {
    _enum: {
      set: {
  ...
  /**
   * Lookup285: pallet_balances::pallet::Call<T, I>
   **/
  PalletBalancesCall: {
    _enum: {
      transfer: {
  ...
  /**
   * Lookup286: pallet_election_provider_multi_phase::pallet::Call<T>
   **/
  ...
  /**
   * Lookup287: pallet_election_provider_multi_phase::RawSolution<joystream_node_runtime::NposSolution16>
   **/
  ...
  /**
   * Lookup288: joystream_node_runtime::NposSolution16
   **/
  ...
  /**
   * Lookup343: sp_npos_elections::Support<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup345: pallet_staking::pallet::pallet::Call<T>
   **/
  ...
  /**
   * Lookup346: pallet_staking::RewardDestination<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup350: pallet_staking::pallet::pallet::ConfigOp<T>
   **/
  ...
  /**
   * Lookup352: pallet_staking::pallet::pallet::ConfigOp<sp_arithmetic::per_things::Percent>
   **/
  ...
  /**
   * Lookup353: pallet_staking::pallet::pallet::ConfigOp<sp_arithmetic::per_things::Perbill>
   **/
  ...
  /**
   * Lookup355: joystream_node_runtime::SessionKeys
   **/
  ...
  /**
   * Lookup356: sp_authority_discovery::app::Public
   **/
  SpAuthorityDiscoveryAppPublic: 'SpCoreSr25519Public',
  /**
   * Lookup357: pallet_grandpa::pallet::Call<T>
   **/
  PalletGrandpaCall: {
    _enum: {
      report_equivocation: {
  ...
  /**
   * Lookup358: sp_consensus_grandpa::EquivocationProof<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup359: sp_consensus_grandpa::Equivocation<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup360: finality_grandpa::Equivocation<sp_consensus_grandpa::app::Public, finality_grandpa::Prevote<primitive_types::H256, N>, sp_consensus_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup361: finality_grandpa::Prevote<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup362: sp_consensus_grandpa::app::Signature
   **/
  ...
  /**
   * Lookup366: finality_grandpa::Equivocation<sp_consensus_grandpa::app::Public, finality_grandpa::Precommit<primitive_types::H256, N>, sp_consensus_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup367: finality_grandpa::Precommit<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup369: pallet_im_online::pallet::Call<T>
   **/
  PalletImOnlineCall: {
    _enum: {
      heartbeat: {
  ...
  /**
   * Lookup370: pallet_im_online::Heartbeat<BlockNumber>
   **/
  ...
  /**
   * Lookup371: sp_core::offchain::OpaqueNetworkState
   **/
  ...
  /**
   * Lookup375: pallet_im_online::sr25519::app_sr25519::Signature
   **/
  ...
  /**
   * Lookup377: pallet_bags_list::pallet::Call<T, I>
   **/
  PalletBagsListCall: {
    _enum: {
      rebag: {
  ...
  /**
   * Lookup378: pallet_vesting::pallet::Call<T>
   **/
  PalletVestingCall: {
    _enum: {
      vest: 'Null',
  ...
  /**
   * Lookup379: pallet_vesting::vesting_info::VestingInfo<Balance, BlockNumber>
   **/
