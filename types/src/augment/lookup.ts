...
export default {
  ...
  /**
   * Lookup76: pallet_forum::RawEvent<CategoryId, ModeratorId, ThreadId, PostId, primitive_types::H256, ForumUserId, pallet_forum::PrivilegedActor<T>, pallet_forum::ExtendedPostIdObject<CategoryId, ThreadId, PostId>>
   **/
  PalletForumRawEvent: {
    _enum: {
  ...
  /**
   * Lookup77: pallet_forum::PrivilegedActor<T>
   **/
  ...
  /**
   * Lookup78: pallet_forum::ExtendedPostIdObject<CategoryId, ThreadId, PostId>
   **/
  ...
  /**
   * Lookup83: pallet_constitution::RawEvent<primitive_types::H256>
   **/
  ...
  /**
   * Lookup84: pallet_bounty::RawEvent<BountyId, EntryId, Balance, MemberId, sp_core::crypto::AccountId32, pallet_bounty::BountyParameters<Balance, BlockNumber, MemberId, BTreeSet<T>>, BTreeMap<K, pallet_bounty::OracleWorkEntryJudgment<Balance>>>
   **/
  ...
  /**
   * Lookup85: pallet_bounty::BountyParameters<Balance, BlockNumber, MemberId, BTreeSet<T>>
   **/
  ...
  /**
   * Lookup87: pallet_bounty::AssuranceContractType<BTreeSet<T>>
   **/
  ...
  /**
   * Lookup88: pallet_bounty::FundingType<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup90: pallet_bounty::OracleWorkEntryJudgment<Balance>
   **/
  ...
  /**
   * Lookup93: pallet_utility::RawEvent<Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup94: pallet_common::working_group::iterable_enums::WorkingGroup
   **/
  ...
  /**
   * Lookup97: pallet_content::permissions::ContentActor<CuratorGroupId, CuratorId, MemberId>
   **/
  ...
  /**
   * Lookup98: pallet_content::types::ChannelRecord<MemberId, CuratorGroupId, Balance, ChannelPrivilegeLevel, BlockNumber, TokenId, TransferId, frame_support::storage::bounded_btree_set::BoundedBTreeSet<T, S>, frame_support::storage::bounded_btree_map::BoundedBTreeMap<K, frame_support::storage::bounded_btree_set::BoundedBTreeSet<pallet_content::types::iterable_enums::ChannelActionPermission, S>, S>, frame_support::storage::bounded_btree_set::BoundedBTreeSet<pallet_content::permissions::curator_group::iterable_enums::PausableChannelFeature, S>, pallet_common::bloat_bond::RepayableBloatBond<sp_core::crypto::AccountId32, Balance>>
   **/
  ...
  /**
   * Lookup102: pallet_content::types::iterable_enums::ChannelActionPermission
   **/
  ...
  /**
   * Lookup109: pallet_content::permissions::curator_group::iterable_enums::PausableChannelFeature
   **/
  ...
  /**
   * Lookup112: pallet_common::bloat_bond::RepayableBloatBond<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup113: pallet_content::types::ChannelOwner<MemberId, CuratorGroupId>
   **/
  ...
  /**
   * Lookup114: pallet_content::types::ChannelTransferStatus<MemberId, CuratorGroupId, Balance, TransferId, frame_support::storage::bounded_btree_map::BoundedBTreeMap<K, frame_support::storage::bounded_btree_set::BoundedBTreeSet<pallet_content::types::iterable_enums::ChannelActionPermission, S>, S>>
   **/
  ...
  /**
   * Lookup115: pallet_content::types::PendingTransfer<MemberId, CuratorGroupId, Balance, TransferId, frame_support::storage::bounded_btree_map::BoundedBTreeMap<K, frame_support::storage::bounded_btree_set::BoundedBTreeSet<pallet_content::types::iterable_enums::ChannelActionPermission, S>, S>>
   **/
  ...
  /**
   * Lookup116: pallet_content::types::TransferCommitmentParameters<frame_support::storage::bounded_btree_map::BoundedBTreeMap<K, frame_support::storage::bounded_btree_set::BoundedBTreeSet<pallet_content::types::iterable_enums::ChannelActionPermission, S>, S>, Balance, TransferId>
   **/
  ...
  /**
   * Lookup117: pallet_content::types::LimitPerPeriod<BlockNumber>
   **/
  ...
  /**
   * Lookup118: pallet_content::types::NftCounter<BlockNumber>
   **/
  ...
  /**
   * Lookup119: pallet_content::nft::types::EnglishAuctionParamsRecord<BlockNumber, Balance, MemberId>
   **/
  ...
  /**
   * Lookup121: pallet_content::nft::types::OpenAuctionParamsRecord<BlockNumber, Balance, MemberId>
   **/
  ...
  /**
   * Lookup122: pallet_content::nft::types::NftIssuanceParametersRecord<MemberId, pallet_content::nft::types::InitTransactionalStatusRecord<pallet_content::nft::types::EnglishAuctionParamsRecord<BlockNumber, Balance, MemberId>, pallet_content::nft::types::OpenAuctionParamsRecord<BlockNumber, Balance, MemberId>, MemberId, Balance>>
   **/
  ...
  /**
   * Lookup123: pallet_content::nft::types::InitTransactionalStatusRecord<pallet_content::nft::types::EnglishAuctionParamsRecord<BlockNumber, Balance, MemberId>, pallet_content::nft::types::OpenAuctionParamsRecord<BlockNumber, Balance, MemberId>, MemberId, Balance>
   **/
  ...
  /**
   * Lookup125: pallet_content::types::ChannelCreationParametersRecord<pallet_content::types::StorageAssetsRecord<Balance>, MemberId, StorageBucketId, pallet_storage::DistributionBucketIdRecord<DistributionBucketFamilyId, DistributionBucketIndex>, Balance>
   **/
  ...
  /**
   * Lookup126: pallet_content::types::StorageAssetsRecord<Balance>
   **/
  ...
  /**
   * Lookup128: pallet_storage::DataObjectCreationParameters
   **/
  ...
  /**
   * Lookup129: pallet_storage::DistributionBucketIdRecord<DistributionBucketFamilyId, DistributionBucketIndex>
   **/
  ...
  /**
   * Lookup136: pallet_content::types::ChannelUpdateParametersRecord<pallet_content::types::StorageAssetsRecord<Balance>, DataObjectId, MemberId, Balance>
   **/
  ...
  /**
   * Lookup140: pallet_content::types::VideoUpdateParametersRecord<pallet_content::types::StorageAssetsRecord<Balance>, DataObjectId, pallet_content::nft::types::NftIssuanceParametersRecord<MemberId, pallet_content::nft::types::InitTransactionalStatusRecord<pallet_content::nft::types::EnglishAuctionParamsRecord<BlockNumber, Balance, MemberId>, pallet_content::nft::types::OpenAuctionParamsRecord<BlockNumber, Balance, MemberId>, MemberId, Balance>>, Balance>
   **/
  ...
  /**
   * Lookup143: pallet_content::permissions::curator_group::iterable_enums::ContentModerationAction
   **/
  ...
  /**
   * Lookup147: pallet_content::types::TransferCommitmentParameters<BTreeMap<K, BTreeSet<pallet_content::types::iterable_enums::ChannelActionPermission>>, Balance, TransferId>
   **/
  ...
  /**
   * Lookup148: pallet_content::types::UpdateChannelPayoutsParametersRecord<pallet_content::types::ChannelPayoutsPayloadParametersRecord<sp_core::crypto::AccountId32, Balance>, Balance, primitive_types::H256>
   **/
  ...
  /**
   * Lookup149: pallet_content::types::ChannelPayoutsPayloadParametersRecord<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup153: pallet_content::types::ChannelFundsDestination<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup156: pallet_storage::UploadParametersRecord<pallet_storage::BagIdType<MemberId, ChannelId>, sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup157: pallet_storage::BagIdType<MemberId, ChannelId>
   **/
  ...
  /**
   * Lookup158: pallet_storage::StaticBagId
   **/
  ...
  /**
   * Lookup159: pallet_storage::DynamicBagIdType<MemberId, ChannelId>
   **/
  ...
  /**
   * Lookup160: pallet_storage::DynBagCreationParametersRecord<pallet_storage::DynamicBagIdType<MemberId, ChannelId>, sp_core::crypto::AccountId32, Balance, StorageBucketId, pallet_storage::DistributionBucketIdRecord<DistributionBucketFamilyId, DistributionBucketIndex>>
   **/
  ...
  /**
   * Lookup163: pallet_storage::Voucher
   **/
  ...
  /**
   * Lookup169: pallet_project_token::types::TransferPolicy<primitive_types::H256>
   **/
  ...
  /**
   * Lookup171: pallet_project_token::types::TokenAllocation<Balance, pallet_project_token::types::VestingScheduleParams<BlockNumber>>
   **/
  ...
  /**
   * Lookup172: pallet_project_token::types::VestingScheduleParams<BlockNumber>
   **/
  ...
  /**
   * Lookup175: pallet_project_token::types::TransferPolicyParams<pallet_project_token::types::WhitelistParams<primitive_types::H256, pallet_project_token::types::SingleDataObjectUploadParams<JoyBalance>>>
   **/
  ...
  /**
   * Lookup176: pallet_project_token::types::WhitelistParams<primitive_types::H256, pallet_project_token::types::SingleDataObjectUploadParams<JoyBalance>>
   **/
  ...
  /**
   * Lookup177: pallet_project_token::types::SingleDataObjectUploadParams<JoyBalance>
   **/
  ...
  /**
   * Lookup184: pallet_project_token::types::Validated<MemberId>
   **/
  ...
  /**
   * Lookup185: pallet_project_token::types::ValidatedPayment<pallet_project_token::types::PaymentWithVesting<Balance, pallet_project_token::types::VestingScheduleParams<BlockNumber>>>
   **/
  ...
  /**
   * Lookup186: pallet_project_token::types::PaymentWithVesting<Balance, pallet_project_token::types::VestingScheduleParams<BlockNumber>>
   **/
  ...
  /**
   * Lookup188: pallet_project_token::types::VestingSource
   **/
  ...
  /**
   * Lookup192: pallet_project_token::types::TokenSale<JoyBalance, Balance, BlockNumber, pallet_project_token::types::VestingScheduleParams<BlockNumber>, MemberId, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup194: pallet_proposals_engine::RawEvent<ProposalId, MemberId, BlockNumber>
   **/
  ...
  /**
   * Lookup195: pallet_proposals_engine::types::proposal_statuses::ProposalStatus<BlockNumber>
   **/
  ...
  /**
   * Lookup196: pallet_proposals_engine::types::proposal_statuses::ProposalDecision
   **/
  ...
  /**
   * Lookup197: pallet_proposals_engine::types::proposal_statuses::ApprovedProposalDecision
   **/
  PalletProposalsEngineProposalStatusesApprovedProposalDecision: {
    _enum: ['PendingExecution', 'PendingConstitutionality']
  },
  /**
   * Lookup198: pallet_proposals_engine::types::proposal_statuses::ExecutionStatus
   **/
  ...
  /**
   * Lookup199: pallet_proposals_engine::types::VoteKind
   **/
  PalletProposalsEngineVoteKind: {
    _enum: ['Approve', 'Reject', 'Slash', 'Abstain']
  },
  /**
   * Lookup200: pallet_proposals_discussion::RawEvent<ThreadId, MemberId, PostId>
   **/
  ...
  /**
   * Lookup201: pallet_proposals_discussion::types::ThreadMode<BTreeSet<T>>
   **/
  ...
  /**
   * Lookup202: pallet_proposals_codex::RawEvent<pallet_proposals_codex::types::GeneralProposalParams<MemberId, sp_core::crypto::AccountId32, BlockNumber>, pallet_proposals_codex::types::ProposalDetails<Balance, BlockNumber, sp_core::crypto::AccountId32, WorkerId, OpeningId, ProposalId, pallet_content::types::UpdateChannelPayoutsParametersRecord<pallet_content::types::ChannelPayoutsPayloadParametersRecord<sp_core::crypto::AccountId32, Balance>, Balance, primitive_types::H256>>, ProposalId, ThreadId>
   **/
  ...
  /**
   * Lookup203: pallet_proposals_codex::types::GeneralProposalParams<MemberId, sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup204: pallet_proposals_codex::types::ProposalDetails<Balance, BlockNumber, sp_core::crypto::AccountId32, WorkerId, OpeningId, ProposalId, pallet_content::types::UpdateChannelPayoutsParametersRecord<pallet_content::types::ChannelPayoutsPayloadParametersRecord<sp_core::crypto::AccountId32, Balance>, Balance, primitive_types::H256>>
   **/
  ...
  /**
   * Lookup206: pallet_common::FundingRequestParameters<Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup207: pallet_proposals_codex::types::CreateOpeningParameters<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup208: pallet_working_group::types::StakePolicy<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup209: pallet_proposals_codex::types::FillOpeningParameters
   **/
  ...
  /**
   * Lookup210: pallet_proposals_codex::types::TerminateRoleParameters<WorkerId, Balance>
   **/
  ...
  /**
   * Lookup215: pallet_working_group::types::OpeningType
   **/
  PalletWorkingGroupOpeningType: {
    _enum: ['Leader', 'Regular']
  },
  /**
   * Lookup216: pallet_working_group::types::ApplyOnOpeningParams<MemberId, OpeningId, sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup217: pallet_working_group::types::StakeParameters<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup218: pallet_working_group::Instance1
   **/
  PalletWorkingGroupInstance1: 'Null',
  /**
   * Lookup219: pallet_working_group::types::RewardPaymentType
   **/
  ...
  /**
   * Lookup221: pallet_working_group::Instance2
   **/
  ...
  /**
   * Lookup223: pallet_working_group::Instance3
   **/
  ...
  /**
   * Lookup225: pallet_working_group::Instance4
   **/
  ...
  /**
   * Lookup227: pallet_working_group::Instance5
   **/
  ...
  /**
   * Lookup229: pallet_working_group::Instance6
   **/
  ...
  /**
   * Lookup231: pallet_working_group::Instance7
   **/
  ...
  /**
   * Lookup233: pallet_working_group::Instance8
   **/
  ...
  /**
   * Lookup235: pallet_working_group::Instance9
   **/
  ...
  /**
   * Lookup247: frame_support::weights::PerDispatchClass<frame_system::limits::WeightsPerClass>
   **/
  ...
  /**
   * Lookup250: frame_support::weights::PerDispatchClass<T>
   **/
  ...
  /**
   * Lookup251: frame_support::weights::RuntimeDbWeight
   **/
  ...
  /**
   * Lookup262: pallet_babe::pallet::Call<T>
   **/
  PalletBabeCall: {
    _enum: {
      report_equivocation: {
  ...
  /**
   * Lookup263: sp_consensus_slots::EquivocationProof<sp_runtime::generic::header::Header<Number, sp_runtime::traits::BlakeTwo256>, sp_consensus_babe::app::Public>
   **/
  ...
  /**
   * Lookup266: sp_consensus_babe::app::Public
   **/
  SpConsensusBabeAppPublic: 'SpCoreSr25519Public',
  /**
   * Lookup268: sp_session::MembershipProof
   **/
  ...
  /**
   * Lookup269: sp_consensus_babe::digests::NextConfigDescriptor
   **/
  ...
  /**
   * Lookup271: pallet_timestamp::pallet::Call<T>
   **/
  PalletTimestampCall: {
    _enum: {
      set: {
  ...
  /**
   * Lookup275: pallet_balances::pallet::Call<T, I>
   **/
  PalletBalancesCall: {
    _enum: {
      transfer: {
  ...
  /**
   * Lookup276: pallet_election_provider_multi_phase::pallet::Call<T>
   **/
  ...
  /**
   * Lookup277: pallet_election_provider_multi_phase::RawSolution<joystream_node_runtime::NposSolution16>
   **/
  ...
  /**
   * Lookup278: joystream_node_runtime::NposSolution16
   **/
  ...
  /**
   * Lookup329: sp_npos_elections::ElectionScore
   **/
  ...
  /**
   * Lookup330: pallet_election_provider_multi_phase::SolutionOrSnapshotSize
   **/
  ...
  /**
   * Lookup334: sp_npos_elections::Support<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup337: pallet_staking::pallet::pallet::Call<T>
   **/
  ...
  /**
   * Lookup338: pallet_staking::RewardDestination<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup342: pallet_staking::pallet::pallet::ConfigOp<T>
   **/
  ...
  /**
   * Lookup344: pallet_staking::pallet::pallet::ConfigOp<sp_arithmetic::per_things::Percent>
   **/
  ...
  /**
   * Lookup345: pallet_staking::pallet::pallet::ConfigOp<sp_arithmetic::per_things::Perbill>
   **/
  ...
  /**
   * Lookup346: pallet_session::pallet::Call<T>
   **/
  PalletSessionCall: {
    _enum: {
      set_keys: {
  ...
  /**
   * Lookup347: joystream_node_runtime::SessionKeys
   **/
  ...
  /**
   * Lookup348: sp_authority_discovery::app::Public
   **/
  ...
  /**
   * Lookup361: pallet_im_online::pallet::Call<T>
   **/
  PalletImOnlineCall: {
    _enum: {
      heartbeat: {
  ...
  /**
   * Lookup362: pallet_im_online::Heartbeat<BlockNumber>
   **/
  ...
  /**
   * Lookup363: sp_core::offchain::OpaqueNetworkState
   **/
  ...
  /**
   * Lookup367: pallet_im_online::sr25519::app_sr25519::Signature
   **/
  ...
  /**
   * Lookup369: pallet_bags_list::pallet::Call<T, I>
   **/
  PalletBagsListCall: {
    _enum: {
      rebag: {
  ...
  /**
   * Lookup370: pallet_vesting::pallet::Call<T>
   **/
  PalletVestingCall: {
    _enum: {
      vest: 'Null',
  ...
  /**
   * Lookup371: pallet_vesting::vesting_info::VestingInfo<Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup372: pallet_multisig::pallet::Call<T>
   **/
  PalletMultisigCall: {
    _enum: {
  ...
  /**
   * Lookup375: pallet_council::Call<T>
   **/
  PalletCouncilCall: {
    _enum: {
      announce_candidacy: {
  ...
  /**
   * Lookup376: pallet_referendum::Call<T, I>
   **/
  ...
  /**
   * Lookup377: pallet_membership::Call<T>
   **/
  ...
  /**
   * Lookup379: pallet_constitution::Call<T>
   **/
  ...
  /**
   * Lookup380: pallet_bounty::Call<T>
   **/
  PalletBountyCall: {
    _enum: {
      create_bounty: {
  ...
  /**
   * Lookup382: pallet_content::Call<T>
   **/
  PalletContentCall: {
    _enum: {
  ...
  /**
   * Lookup383: pallet_content::types::ChannelBagWitness
   **/
  ...
  /**
   * Lookup385: pallet_common::merkle_tree::ProofElementRecord<primitive_types::H256, pallet_common::merkle_tree::Side>
   **/
  ...
  /**
   * Lookup386: pallet_common::merkle_tree::Side
   **/
  PalletCommonMerkleTreeSide: {
    _enum: ['Left', 'Right']
  },
  /**
   * Lookup387: pallet_content::types::PullPaymentElement<ChannelId, Balance, primitive_types::H256>
   **/
  ...
  /**
   * Lookup388: pallet_content::types::InitTransferParameters<MemberId, CuratorGroupId, Balance>
   **/
  ...
  /**
   * Lookup389: pallet_project_token::types::TokenSaleParams<JoyBalance, Balance, BlockNumber, pallet_project_token::types::VestingScheduleParams<BlockNumber>>
   **/
  ...
  /**
   * Lookup390: pallet_project_token::types::Transfers<MemberId, pallet_project_token::types::PaymentWithVesting<Balance, pallet_project_token::types::VestingScheduleParams<BlockNumber>>>
   **/
  PalletProjectTokenTransfersPaymentWithVesting: 'BTreeMap<u64, PalletProjectTokenPaymentWithVesting>',
  /**
   * Lookup394: pallet_storage::Call<T>
   **/
  PalletStorageCall: {
    _enum: {
  ...
  /**
   * Lookup395: pallet_project_token::Call<T>
   **/
  ...
  /**
   * Lookup396: pallet_project_token::types::Transfers<MemberId, pallet_project_token::types::Payment<Balance>>
   **/
  PalletProjectTokenTransfersPayment: 'BTreeMap<u64, PalletProjectTokenPayment>',
  /**
   * Lookup397: pallet_project_token::types::Payment<Balance>
   **/
  PalletProjectTokenPayment: {
    amount: 'u128'
  },
  /**
   * Lookup401: pallet_project_token::types::MerkleProof<sp_runtime::traits::BlakeTwo256>
   **/
  PalletProjectTokenMerkleProof: 'Vec<(H256,PalletProjectTokenMerkleSide)>',
  /**
   * Lookup404: pallet_project_token::types::MerkleSide
   **/
  PalletProjectTokenMerkleSide: {
    _enum: ['Right', 'Left']
  },
  /**
   * Lookup405: pallet_proposals_engine::Call<T>
   **/
  ...
  /**
   * Lookup406: pallet_proposals_discussion::Call<T>
   **/
  ...
  /**
   * Lookup407: pallet_proposals_codex::Call<T>
   **/
  ...
  /**
   * Lookup408: pallet_working_group::Call<T, I>
   **/
  ...
  /**
   * Lookup417: joystream_node_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup418: frame_support::dispatch::RawOrigin<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup419: sp_core::Void
   **/
  SpCoreVoid: 'Null',
  /**
   * Lookup420: pallet_utility::pallet::Error<T>
   **/
  PalletUtilityError: {
    _enum: ['TooManyCalls']
  },
  /**
   * Lookup427: sp_consensus_babe::digests::PreDigest
   **/
  ...
  /**
   * Lookup428: sp_consensus_babe::digests::PrimaryPreDigest
   **/
  ...
  /**
   * Lookup429: sp_consensus_babe::digests::SecondaryPlainPreDigest
   **/
  ...
  /**
   * Lookup430: sp_consensus_babe::digests::SecondaryVRFPreDigest
   **/
  ...
  /**
   * Lookup432: sp_consensus_babe::BabeEpochConfiguration
   **/
  ...
  /**
   * Lookup433: pallet_babe::pallet::Error<T>
   **/
  PalletBabeError: {
  ...
  /**
   * Lookup436: pallet_authorship::pallet::Error<T>
   **/
  PalletAuthorshipError: {
    _enum: ['InvalidUncleParent', 'UnclesAlreadySet', 'TooManyUncles', 'GenesisUncle', 'TooHighUncle', 'UncleAlreadyIncluded', 'OldUncle']
  },
  /**
   * Lookup438: pallet_balances::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup439: pallet_balances::Reasons
   **/
  PalletBalancesReasons: {
    _enum: ['Fee', 'Misc', 'All']
  },
  /**
   * Lookup442: pallet_balances::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup444: pallet_balances::Releases
   **/
  ...
  /**
   * Lookup448: pallet_election_provider_multi_phase::Phase<Bn>
   **/
  ...
  /**
   * Lookup450: pallet_election_provider_multi_phase::ReadySolution<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup459: pallet_election_provider_multi_phase::signed::SignedSubmission<sp_core::crypto::AccountId32, Balance, joystream_node_runtime::NposSolution16>
   **/
  ...
  /**
   * Lookup460: pallet_election_provider_multi_phase::pallet::Error<T>
   **/
  ...
  /**
   * Lookup461: pallet_staking::StakingLedger<T>
   **/
  ...
  /**
   * Lookup463: pallet_staking::UnlockChunk<Balance>
   **/
  ...
  /**
   * Lookup472: pallet_staking::Forcing
   **/
  ...
  /**
   * Lookup480: pallet_staking::Releases
   **/
  PalletStakingReleases: {
    _enum: ['V1_0_0Ancient', 'V2_0_0', 'V3_0_0', 'V4_0_0', 'V5_0_0', 'V6_0_0', 'V7_0_0', 'V8_0_0', 'V9_0_0']
  },
  /**
   * Lookup481: pallet_staking::pallet::pallet::Error<T>
   **/
  ...
  /**
   * Lookup502: sp_staking::offence::OffenceDetails<sp_core::crypto::AccountId32, Offender>
   **/
  ...
  /**
   * Lookup505: pallet_bags_list::list::Node<T, I>
   **/
  ...
  /**
   * Lookup506: pallet_bags_list::list::Bag<T, I>
   **/
  ...
  /**
   * Lookup507: pallet_bags_list::pallet::Error<T, I>
   **/
  PalletBagsListError: {
    _enum: {
  ...
  /**
   * Lookup508: pallet_bags_list::list::ListError
   **/
  ...
  /**
   * Lookup514: pallet_multisig::Multisig<BlockNumber, Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup516: pallet_multisig::pallet::Error<T>
   **/
  PalletMultisigError: {
    _enum: ['MinimumThreshold', 'AlreadyApproved', 'NoApprovalsNeeded', 'TooFewSignatories', 'TooManySignatories', 'SignatoriesOutOfOrder', 'SenderInSignatories', 'NotFound', 'NotOwner', 'NoTimepoint', 'WrongTimepoint', 'UnexpectedTimepoint', 'MaxWeightTooLow', 'AlreadyStored']
  },
  /**
   * Lookup517: pallet_council::CouncilStageUpdate<BlockNumber>
   **/
  ...
  /**
   * Lookup518: pallet_council::CouncilStage<BlockNumber>
   **/
  ...
  /**
   * Lookup519: pallet_council::CouncilStageAnnouncing<BlockNumber>
   **/
  ...
  /**
   * Lookup520: pallet_council::CouncilStageElection
   **/
  PalletCouncilCouncilStageElection: {
    candidatesCount: 'u32'
  },
  /**
   * Lookup521: pallet_council::CouncilStageIdle<BlockNumber>
   **/
  PalletCouncilCouncilStageIdle: {
    endsAt: 'u32'
  },
  /**
   * Lookup523: pallet_council::CouncilMember<sp_core::crypto::AccountId32, MemberId, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup525: pallet_council::Candidate<sp_core::crypto::AccountId32, Balance, primitive_types::H256, VotePower>
   **/
  ...
  /**
   * Lookup526: pallet_council::Error<T>
   **/
  PalletCouncilError: {
  ...
  /**
   * Lookup527: pallet_referendum::ReferendumStage<BlockNumber, frame_support::storage::weak_bounded_vec::WeakBoundedVec<pallet_referendum::OptionResult<MemberId, VotePower>, S>>
   **/
  ...
  /**
   * Lookup529: pallet_referendum::ReferendumStageVoting<BlockNumber>
   **/
  ...
  /**
   * Lookup530: pallet_referendum::ReferendumStageRevealing<BlockNumber, frame_support::storage::weak_bounded_vec::WeakBoundedVec<pallet_referendum::OptionResult<MemberId, VotePower>, S>>
   **/
  ...
  /**
   * Lookup531: pallet_referendum::CastVote<primitive_types::H256, Currency, MemberId>
   **/
  ...
  /**
   * Lookup532: pallet_referendum::Error<T, I>
   **/
  ...
  /**
   * Lookup533: pallet_membership::MembershipObject<sp_core::crypto::AccountId32, primitive_types::H256>
   **/
  ...
  /**
   * Lookup534: pallet_membership::StakingAccountMemberBinding<MemberId>
   **/
  ...
  /**
   * Lookup535: pallet_membership::Error<T>
   **/
  ...
  /**
   * Lookup536: pallet_forum::Category<CategoryId, primitive_types::H256, frame_support::storage::bounded_btree_set::BoundedBTreeSet<T, S>>
   **/
  PalletForumCategory: {
    titleHash: 'H256',
  ...
  /**
   * Lookup538: pallet_forum::Thread<ForumUserId, CategoryId, pallet_common::bloat_bond::RepayableBloatBond<sp_core::crypto::AccountId32, Balance>>
   **/
  PalletForumThread: {
    categoryId: 'u64',
    authorId: 'u64',
  ...
  /**
   * Lookup539: pallet_forum::Post<ForumUserId, ThreadId, primitive_types::H256, BlockNumber, pallet_common::bloat_bond::RepayableBloatBond<sp_core::crypto::AccountId32, Balance>>
   **/
  PalletForumPost: {
    threadId: 'u64',
    textHash: 'H256',
  ...
  /**
   * Lookup540: pallet_forum::Error<T>
   **/
  PalletForumError: {
  ...
  /**
   * Lookup541: pallet_constitution::ConstitutionInfo<primitive_types::H256>
   **/
  PalletConstitutionConstitutionInfo: {
    textHash: 'H256'
  },
  /**
   * Lookup542: pallet_bounty::BountyRecord<Balance, BlockNumber, MemberId, frame_support::storage::bounded_btree_set::BoundedBTreeSet<T, S>>
   **/
  ...
  /**
   * Lookup544: pallet_bounty::BountyParameters<Balance, BlockNumber, MemberId, frame_support::storage::bounded_btree_set::BoundedBTreeSet<T, S>>
   **/
  ...
  /**
   * Lookup545: pallet_bounty::AssuranceContractType<frame_support::storage::bounded_btree_set::BoundedBTreeSet<T, S>>
   **/
  ...
  /**
   * Lookup546: pallet_bounty::BountyMilestone<BlockNumber>
   **/
  ...
  /**
   * Lookup548: pallet_bounty::Contribution<T>
   **/
  ...
  /**
   * Lookup549: pallet_bounty::EntryRecord<sp_core::crypto::AccountId32, MemberId, BlockNumber>
   **/
  ...
  /**
   * Lookup550: pallet_bounty::Error<T>
   **/
  PalletBountyError: {
  ...
  /**
   * Lookup553: pallet_content::nft::types::OwnedNft<pallet_content::nft::types::TransactionalStatusRecord<MemberId, Balance, pallet_content::nft::types::EnglishAuctionRecord<BlockNumber, Balance, MemberId, frame_support::storage::bounded_btree_set::BoundedBTreeSet<T, S>>, pallet_content::nft::types::OpenAuctionRecord<BlockNumber, AuctionId, Balance, frame_support::storage::bounded_btree_set::BoundedBTreeSet<T, S>>>, MemberId, AuctionId>
   **/
  ...
  /**
   * Lookup554: pallet_content::nft::types::TransactionalStatusRecord<MemberId, Balance, pallet_content::nft::types::EnglishAuctionRecord<BlockNumber, Balance, MemberId, frame_support::storage::bounded_btree_set::BoundedBTreeSet<T, S>>, pallet_content::nft::types::OpenAuctionRecord<BlockNumber, AuctionId, Balance, frame_support::storage::bounded_btree_set::BoundedBTreeSet<T, S>>>
   **/
  ...
  /**
   * Lookup555: pallet_content::nft::types::EnglishAuctionRecord<BlockNumber, Balance, MemberId, frame_support::storage::bounded_btree_set::BoundedBTreeSet<T, S>>
   **/
  ...
  /**
   * Lookup558: pallet_content::nft::types::EnglishAuctionBid<Balance, MemberId>
   **/
  ...
  /**
   * Lookup559: pallet_content::nft::types::OpenAuctionRecord<BlockNumber, AuctionId, Balance, frame_support::storage::bounded_btree_set::BoundedBTreeSet<T, S>>
   **/
  ...
  /**
   * Lookup560: pallet_content::nft::types::NftOwner<MemberId>
   **/
  ...
  /**
   * Lookup570: pallet_content::nft::types::OpenAuctionBidRecord<Balance, BlockNumber, AuctionId>
   **/
  ...
  /**
   * Lookup571: pallet_content::errors::Error<T>
   **/
  ...
  /**
   * Lookup572: pallet_storage::BagRecord<frame_support::storage::bounded_btree_set::BoundedBTreeSet<T, S>, frame_support::storage::bounded_btree_set::BoundedBTreeSet<pallet_storage::DistributionBucketIdRecord<DistributionBucketFamilyId, DistributionBucketIndex>, S>>
   **/
  ...
  /**
   * Lookup575: pallet_storage::StorageBucketRecord<WorkerId, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup576: pallet_storage::StorageBucketOperatorStatus<WorkerId, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup578: pallet_storage::DynamicBagCreationPolicy<frame_support::storage::bounded_btree_map::BoundedBTreeMap<K, V, S>>
   **/
  ...
  /**
   * Lookup581: pallet_storage::DataObject<pallet_common::bloat_bond::RepayableBloatBond<sp_core::crypto::AccountId32, Balance>>
   **/
  ...
  /**
   * Lookup582: pallet_storage::DistributionBucketFamilyRecord<DistributionBucketIndex>
   **/
  PalletStorageDistributionBucketFamilyRecord: {
    nextDistributionBucketIndex: 'u64'
  },
  /**
   * Lookup583: pallet_storage::DistributionBucketRecord<frame_support::storage::bounded_btree_set::BoundedBTreeSet<T, S>, frame_support::storage::bounded_btree_set::BoundedBTreeSet<T, S>>
   **/
  ...
  /**
   * Lookup586: pallet_storage::Error<T>
   **/
  PalletStorageError: {
  ...
  /**
   * Lookup587: pallet_project_token::types::AccountData<Balance, pallet_project_token::types::StakingStatus<Balance>, pallet_common::bloat_bond::RepayableBloatBond<sp_core::crypto::AccountId32, Balance>, frame_support::storage::bounded_btree_map::BoundedBTreeMap<pallet_project_token::types::VestingSource, pallet_project_token::types::VestingSchedule<BlockNumber, Balance>, S>>
   **/
  ...
  /**
   * Lookup588: pallet_project_token::types::StakingStatus<Balance>
   **/
  ...
  /**
   * Lookup590: pallet_project_token::types::VestingSchedule<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup598: pallet_project_token::types::RevenueSplitState<JoyBalance, BlockNumber>
   **/
  ...
  /**
   * Lookup599: pallet_project_token::types::RevenueSplitInfo<JoyBalance, BlockNumber>
   **/
  ...
  /**
   * Lookup600: pallet_project_token::types::Timeline<BlockNumber>
   **/
  ...
  /**
   * Lookup602: pallet_project_token::types::PatronageData<Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup604: pallet_project_token::errors::Error<T>
   **/
  ...
  /**
   * Lookup605: pallet_proposals_engine::types::Proposal<BlockNumber, ProposerId, Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup606: pallet_proposals_engine::types::ProposalParameters<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup607: pallet_proposals_engine::types::VotingResults
   **/
  ...
  /**
   * Lookup610: pallet_proposals_engine::Error<T>
   **/
  ...
  /**
   * Lookup611: pallet_proposals_discussion::types::DiscussionThread<MemberId, BlockNumber, frame_support::storage::bounded_btree_set::BoundedBTreeSet<T, S>>
   **/
  ...
  /**
   * Lookup613: pallet_proposals_discussion::types::ThreadMode<frame_support::storage::bounded_btree_set::BoundedBTreeSet<T, S>>
   **/
  ...
  /**
   * Lookup614: pallet_proposals_discussion::types::DiscussionPost<MemberId, BlockNumber, pallet_common::bloat_bond::RepayableBloatBond<sp_core::crypto::AccountId32, Balance>>
   **/
  ...
  /**
   * Lookup615: pallet_proposals_discussion::Error<T>
   **/
  ...
  /**
   * Lookup616: pallet_proposals_codex::Error<T>
   **/
  ...
  /**
   * Lookup617: pallet_working_group::types::Opening<BlockNumber, Balance, primitive_types::H256>
   **/
  ...
  /**
   * Lookup618: pallet_working_group::types::JobApplication<sp_core::crypto::AccountId32, MemberId, primitive_types::H256>
   **/
  ...
  /**
   * Lookup619: pallet_working_group::types::GroupWorker<sp_core::crypto::AccountId32, MemberId, BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup620: pallet_working_group::errors::Error<T, I>
   **/
  ...
  /**
   * Lookup631: sp_core::ecdsa::Signature
   **/
  SpCoreEcdsaSignature: '[u8;65]',
  /**
   * Lookup634: frame_system::extensions::check_non_zero_sender::CheckNonZeroSender<T>
   **/
  ...
  /**
   * Lookup643: joystream_node_runtime::Runtime
   **/
