...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    PalletCommonIterableEnumsFreezablePallet: PalletCommonIterableEnumsFreezablePallet;
