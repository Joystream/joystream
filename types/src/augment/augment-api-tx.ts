  ...
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    appWorkingGroup: {
      ...
      addOpening: AugmentedSubmittable<
        (
          ...
          stakePolicy:
            ...
            | string
            | Uint8Array,
          rewardPerBlock: Option<u128> | null | Uint8Array | u128 | AnyNumber
      ...
      leaveRole: AugmentedSubmittable<
        (
          workerId: u64 | AnyNumber | Uint8Array,
          rationale: Option<Bytes> | null | Uint8Array | Bytes | string
        ) => SubmittableExtrinsic<ApiType>,
        [u64, Option<Bytes>]
      >
      /**
      ...
      setStatusText: AugmentedSubmittable<
        (statusText: Option<Bytes> | null | Uint8Array | Bytes | string) => SubmittableExtrinsic<ApiType>,
        [Option<Bytes>]
      >
      /**
      ...
      terminateRole: AugmentedSubmittable<
        (
          workerId: u64 | AnyNumber | Uint8Array,
          penalty: Option<u128> | null | Uint8Array | u128 | AnyNumber,
          rationale: Option<Bytes> | null | Uint8Array | Bytes | string
        ) => SubmittableExtrinsic<ApiType>,
    ...
    content: {
      ...
      acceptIncomingOffer: AugmentedSubmittable<
        (
          ...
          witnessPrice: Option<u128> | null | Uint8Array | u128 | AnyNumber
        ) => SubmittableExtrinsic<ApiType>,
        [u64, Option<u128>]
      >
      /**
       ...
       **/
      creatorTokenIssuerRemark: AugmentedSubmittable<
        (
          actor:
            | PalletContentPermissionsContentActor
            | { Curator: any }
      ...
      deleteVideo: AugmentedSubmittable<
        (
          ...
          videoId: u64 | AnyNumber | Uint8Array,
          numObjectsToDelete: u64 | AnyNumber | Uint8Array,
          storageBucketsNumWitness: Option<u32> | null | Uint8Array | u32 | AnyNumber
        ) => SubmittableExtrinsic<ApiType>,
      ...
      updateUpcomingCreatorTokenSale: AugmentedSubmittable<
        (
          actor:
            ...
            | Uint8Array,
          channelId: u64 | AnyNumber | Uint8Array,
          newStartBlock: Option<u32> | null | Uint8Array | u32 | AnyNumber,
          newDuration: Option<u32> | null | Uint8Array | u32 | AnyNumber
        ) => SubmittableExtrinsic<ApiType>,
    ...
    council: {
       ...
       * # </weight>
       **/
      decreaseCouncilBudget: AugmentedSubmittable<
        (reductionAmount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u128]
      >
      /**
    ...
    forum: {
      ...
      createCategory: AugmentedSubmittable<
        (
          parentCategoryId: Option<u64> | null | Uint8Array | u64 | AnyNumber,
    ...
    members: {
      ...
      updateAccounts: AugmentedSubmittable<
        (
          memberId: u64 | AnyNumber | Uint8Array,
          newRootAccount: Option<AccountId32> | null | Uint8Array | AccountId32 | string,
          newControllerAccount: Option<AccountId32> | null | Uint8Array | AccountId32 | string
        ) => SubmittableExtrinsic<ApiType>,
      ...
      updateProfile: AugmentedSubmittable<
        (
          memberId: u64 | AnyNumber | Uint8Array,
          handle: Option<Bytes> | null | Uint8Array | Bytes | string,
    ...
    projectToken: {
      ...
      buyOnAmm: AugmentedSubmittable<
        (
          ...
          amount: u128 | AnyNumber | Uint8Array,
          slippageTolerance:
            | Option<ITuple<[Permill, u128]>>
            | null
            | Uint8Array
            | ITuple<[Permill, u128]>
            | [Permill | AnyNumber | Uint8Array, u128 | AnyNumber | Uint8Array]
        ) => SubmittableExtrinsic<ApiType>,
       ...
       * # </weight>
       **/
      setFrozenStatus: AugmentedSubmittable<
        (freeze: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [bool]
      >
      /**
    ...
    storage: {
      ...
      createStorageBucket: AugmentedSubmittable<
        (
          inviteWorker: Option<u64> | null | Uint8Array | u64 | AnyNumber,
          acceptingNewBags: bool | boolean | Uint8Array,
