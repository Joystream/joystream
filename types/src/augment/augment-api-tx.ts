...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    argoBridge: {
      finalizeInboundTransfer: AugmentedSubmittable<(remoteTransfer: PalletArgoBridgeRemoteTransfer | { id?: any; chainId?: any } | string | Uint8Array, destAccount: AccountId32 | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletArgoBridgeRemoteTransfer, AccountId32, u128]>;
       ...
       * # </weight>
       **/
      updateBridgeConstrains: AugmentedSubmittable<(parameters: PalletArgoBridgeBridgeConstraints | { operatorAccount?: any; pauserAccounts?: any; bridgingFee?: any; thawnDuration?: any; remoteChains?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletArgoBridgeBridgeConstraints]>;
    };
    babe: {
      /**
