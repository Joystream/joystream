...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletProjectTokenGovernanceParameters (202) */
  interface PalletProjectTokenGovernanceParameters extends Struct {
  ...
  /** @name PalletWorkingGroupInstance1 (230) */
  type PalletWorkingGroupInstance1 = Null;

  /** @name PalletWorkingGroupRewardPaymentType (231) */
  ...
  /** @name PalletWorkingGroupRawEventInstance2 (232) */
  ...
  /** @name PalletWorkingGroupInstance2 (233) */
  type PalletWorkingGroupInstance2 = Null;

  /** @name PalletWorkingGroupRawEventInstance3 (234) */
  ...
  /** @name PalletWorkingGroupInstance3 (235) */
  type PalletWorkingGroupInstance3 = Null;

  /** @name PalletWorkingGroupRawEventInstance4 (236) */
  ...
  /** @name PalletWorkingGroupInstance4 (237) */
  type PalletWorkingGroupInstance4 = Null;

  /** @name PalletWorkingGroupRawEventInstance5 (238) */
  ...
  /** @name PalletWorkingGroupInstance5 (239) */
  type PalletWorkingGroupInstance5 = Null;

  /** @name PalletWorkingGroupRawEventInstance6 (240) */
  ...
  /** @name PalletWorkingGroupInstance6 (241) */
  type PalletWorkingGroupInstance6 = Null;

  /** @name PalletWorkingGroupRawEventInstance7 (242) */
  ...
  /** @name PalletWorkingGroupInstance7 (243) */
  type PalletWorkingGroupInstance7 = Null;

  /** @name PalletWorkingGroupRawEventInstance8 (244) */
  ...
  /** @name PalletWorkingGroupInstance8 (245) */
  type PalletWorkingGroupInstance8 = Null;

  /** @name PalletWorkingGroupRawEventInstance9 (246) */
  ...
  /** @name PalletWorkingGroupInstance9 (247) */
  type PalletWorkingGroupInstance9 = Null;

  /** @name FrameSystemPhase (248) */
  ...
  /** @name FrameSystemLimitsBlockWeights (258) */
  ...
  /** @name FrameSupportDispatchPerDispatchClassWeightsPerClass (259) */
  ...
  /** @name FrameSystemLimitsWeightsPerClass (260) */
  ...
  /** @name FrameSystemLimitsBlockLength (262) */
  interface FrameSystemLimitsBlockLength extends Struct {
    readonly max: FrameSupportDispatchPerDispatchClassU32;
  }

  /** @name FrameSupportDispatchPerDispatchClassU32 (263) */
  ...
  /** @name SpWeightsRuntimeDbWeight (264) */
  interface SpWeightsRuntimeDbWeight extends Struct {
    readonly read: u64;
    readonly write: u64;
  }

  /** @name SpVersionRuntimeVersion (265) */
  ...
  /** @name SpConsensusSlotsEquivocationProof (276) */
  ...
  /** @name SpRuntimeBlakeTwo256 (278) */
  type SpRuntimeBlakeTwo256 = Null;

  /** @name SpConsensusBabeAppPublic (279) */
  interface SpConsensusBabeAppPublic extends SpCoreSr25519Public {}

  /** @name SpSessionMembershipProof (281) */
  ...
  /** @name SpConsensusBabeAllowedSlots (283) */
  ...
  /** @name PalletElectionProviderMultiPhaseCall (286) */
  ...
  /** @name PalletElectionProviderMultiPhaseRawSolution (287) */
  ...
  /** @name JoystreamNodeRuntimeNposSolution16 (288) */
  ...
  /** @name PalletElectionProviderMultiPhaseSolutionOrSnapshotSize (339) */
  interface PalletElectionProviderMultiPhaseSolutionOrSnapshotSize extends Struct {
    readonly voters: Compact<u32>;
    readonly targets: Compact<u32>;
  }

  /** @name SpNposElectionsSupport (343) */
  interface SpNposElectionsSupport extends Struct {
    readonly total: u128;
    readonly voters: Vec<ITuple<[AccountId32, u128]>>;
  }

  /** @name PalletStakingPalletCall (345) */
  ...
  /** @name PalletStakingRewardDestination (346) */
  ...
  /** @name PalletStakingPalletConfigOpU128 (350) */
  ...
  /** @name PalletStakingPalletConfigOpU32 (351) */
  ...
  /** @name PalletStakingPalletConfigOpPercent (352) */
  ...
  /** @name PalletStakingPalletConfigOpPerbill (353) */
  ...
  /** @name JoystreamNodeRuntimeSessionKeys (355) */
  ...
  /** @name SpConsensusGrandpaEquivocationProof (358) */
  interface SpConsensusGrandpaEquivocationProof extends Struct {
    readonly setId: u64;
    readonly equivocation: SpConsensusGrandpaEquivocation;
  }

  /** @name SpConsensusGrandpaEquivocation (359) */
  ...
  /** @name FinalityGrandpaEquivocationPrevote (360) */
  ...
  /** @name FinalityGrandpaPrevote (361) */
  interface FinalityGrandpaPrevote extends Struct {
    readonly targetHash: H256;
    readonly targetNumber: u32;
  }

  /** @name SpConsensusGrandpaAppSignature (362) */
  interface SpConsensusGrandpaAppSignature extends SpCoreEd25519Signature {}

  /** @name SpCoreEd25519Signature (363) */
  interface SpCoreEd25519Signature extends U8aFixed {}

  /** @name FinalityGrandpaEquivocationPrecommit (366) */
  ...
  /** @name FinalityGrandpaPrecommit (367) */
  interface FinalityGrandpaPrecommit extends Struct {
    readonly targetHash: H256;
    readonly targetNumber: u32;
  }

  /** @name PalletImOnlineCall (369) */
  ...
  /** @name PalletImOnlineHeartbeat (370) */
  ...
  /** @name SpCoreOffchainOpaqueNetworkState (371) */
  interface SpCoreOffchainOpaqueNetworkState extends Struct {
    readonly peerId: OpaquePeerId;
    readonly externalAddresses: Vec<OpaqueMultiaddr>;
  }

  /** @name PalletImOnlineSr25519AppSr25519Signature (375) */
  interface PalletImOnlineSr25519AppSr25519Signature extends SpCoreSr25519Signature {}

  /** @name SpCoreSr25519Signature (376) */
  interface SpCoreSr25519Signature extends U8aFixed {}

  /** @name PalletBagsListCall (377) */
  ...
  /** @name PalletVestingVestingInfo (379) */
