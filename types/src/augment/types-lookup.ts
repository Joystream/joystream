...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletContentChannelOwner (97) */
  ...
  /** @name PalletContentTransferCommitmentParametersBoundedBTreeMap (103) */
  ...
  /** @name PalletContentTransferCommitmentParametersBTreeMap (131) */
  ...
  /** @name PalletContentChannelBagWitness (363) */
  ...
  /** @name PalletCouncilCouncilStageIdle (499) */
  ...
  export interface PalletContentErrorsError extends Enum {
    ...
    readonly isMissingChannelBagWitness: boolean;
