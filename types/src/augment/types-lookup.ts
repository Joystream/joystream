...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletConstitutionEvent (78) */
  ...
  /** @name PalletCommonWorkingGroup (80) */
  ...
  /** @name PalletCommonBalanceKind (81) */
  ...
  /** @name PalletContentPermissionsContentActor (83) */
  ...
  /** @name PalletContentChannelRecord (84) */
  ...
  /** @name PalletContentChannelOwner (85) */
  ...
  /** @name PalletContentChannelActionPermission (88) */
  ...
  /** @name PalletContentPermissionsCuratorGroupPausableChannelFeature (93) */
  ...
  /** @name PalletContentChannelTransferStatus (95) */
  ...
  /** @name PalletContentPendingTransfer (96) */
  ...
  /** @name PalletContentTransferCommitmentParameters (97) */
  ...
  /** @name PalletContentNftTypesOpenAuctionParamsRecord (104) */
  ...
  /** @name PalletContentNftTypesNftIssuanceParametersRecord (105) */
  ...
  /** @name PalletContentNftTypesInitTransactionalStatusRecord (106) */
  ...
  /** @name PalletContentChannelCreationParametersRecord (108) */
  ...
  /** @name PalletContentStorageAssetsRecord (109) */
  ...
  /** @name PalletContentChannelUpdateParametersRecord (116) */
  ...
  /** @name PalletContentVideoCreationParametersRecord (118) */
  ...
  /** @name PalletContentVideoUpdateParametersRecord (120) */
  ...
  /** @name PalletContentPermissionsCuratorGroupContentModerationAction (123) */
  ...
  /** @name PalletContentUpdateChannelPayoutsParametersRecord (127) */
  ...
  /** @name PalletContentChannelPayoutsPayloadParametersRecord (128) */
  ...
  /** @name PalletContentChannelFundsDestination (132) */
  ...
  /** @name PalletContentNftLimitPeriod (133) */
  ...
  /** @name PalletStorageRawEvent (134) */
  ...
  /** @name PalletStorageUploadParametersRecord (135) */
  ...
  /** @name PalletStorageBagIdType (136) */
  ...
  /** @name PalletStorageStaticBagId (137) */
  ...
  /** @name PalletStorageDynamicBagIdType (138) */
  ...
  /** @name PalletStorageDynamicBagType (142) */
  ...
  /** @name PalletProjectTokenEventsRawEvent (146) */
  ...
  /** @name PalletProjectTokenTransferPolicy (147) */
  ...
  /** @name PalletProjectTokenTokenIssuanceParameters (148) */
  ...
  /** @name PalletProjectTokenTokenAllocation (149) */
  ...
  /** @name PalletProjectTokenVestingScheduleParams (150) */
  ...
  /** @name PalletProjectTokenTransferPolicyParams (153) */
  ...
  /** @name PalletProjectTokenWhitelistParams (154) */
  ...
  /** @name PalletProjectTokenSingleDataObjectUploadParams (155) */
  ...
  /** @name PalletProjectTokenValidated (162) */
  ...
  /** @name PalletProjectTokenValidatedPayment (163) */
  ...
  /** @name PalletProjectTokenPaymentWithVesting (164) */
  ...
  /** @name PalletProjectTokenVestingSource (166) */
  ...
  /** @name PalletProjectTokenTokenSale (170) */
  ...
  /** @name PalletProposalsEngineRawEvent (172) */
  ...
  /** @name PalletProposalsEngineProposalStatusesProposalStatus (173) */
  ...
  /** @name PalletProposalsEngineProposalStatusesProposalDecision (174) */
  ...
  /** @name PalletProposalsEngineProposalStatusesApprovedProposalDecision (175) */
  ...
  /** @name PalletProposalsEngineProposalStatusesExecutionStatus (176) */
  ...
  /** @name PalletProposalsEngineVoteKind (177) */
  ...
  /** @name PalletProposalsDiscussionRawEvent (178) */
  ...
  /** @name PalletProposalsDiscussionThreadMode (179) */
  ...
  /** @name PalletProposalsCodexRawEvent (180) */
  ...
  /** @name PalletProposalsCodexGeneralProposalParams (181) */
  ...
  /** @name PalletProposalsCodexProposalDetails (182) */
  ...
  /** @name PalletCommonFundingRequestParameters (184) */
  export interface PalletCommonFundingRequestParameters extends Struct {
    readonly account: AccountId32;
    readonly amount: u128;
  }

  /** @name PalletProposalsCodexCreateOpeningParameters (185) */
  ...
  /** @name PalletWorkingGroupStakePolicy (186) */
  ...
  /** @name PalletProposalsCodexFillOpeningParameters (187) */
  ...
  /** @name PalletProposalsCodexTerminateRoleParameters (188) */
  ...
  /** @name PalletWorkingGroupRawEventInstance1 (189) */
  ...
  /** @name PalletWorkingGroupOpeningType (193) */
  ...
  /** @name PalletWorkingGroupApplyOnOpeningParams (194) */
  ...
  /** @name PalletWorkingGroupRawEventInstance2 (198) */
  ...
  /** @name PalletWorkingGroupInstance2 (199) */
  export type PalletWorkingGroupInstance2 = Null;

  /** @name PalletWorkingGroupRawEventInstance3 (200) */
  ...
  /** @name PalletWorkingGroupInstance3 (201) */
  export type PalletWorkingGroupInstance3 = Null;

  /** @name PalletWorkingGroupRawEventInstance4 (202) */
  ...
  /** @name PalletWorkingGroupInstance4 (203) */
  export type PalletWorkingGroupInstance4 = Null;

  /** @name PalletWorkingGroupRawEventInstance5 (204) */
  ...
  /** @name PalletWorkingGroupInstance5 (205) */
  export type PalletWorkingGroupInstance5 = Null;

  /** @name PalletWorkingGroupRawEventInstance6 (206) */
  ...
  /** @name PalletWorkingGroupInstance6 (207) */
  export type PalletWorkingGroupInstance6 = Null;

  /** @name PalletWorkingGroupRawEventInstance7 (208) */
  ...
  /** @name PalletWorkingGroupInstance7 (209) */
  export type PalletWorkingGroupInstance7 = Null;

  /** @name PalletWorkingGroupRawEventInstance8 (210) */
  ...
  /** @name PalletWorkingGroupInstance8 (211) */
  export type PalletWorkingGroupInstance8 = Null;

  /** @name PalletWorkingGroupRawEventInstance9 (212) */
  ...
  /** @name PalletWorkingGroupInstance9 (213) */
  export type PalletWorkingGroupInstance9 = Null;

  /** @name FrameSystemPhase (214) */
  ...
  /** @name FrameSystemLastRuntimeUpgradeInfo (218) */
  export interface FrameSystemLastRuntimeUpgradeInfo extends Struct {
    readonly specVersion: Compact<u32>;
    readonly specName: Text;
  }

  /** @name FrameSystemCall (221) */
  ...
  /** @name FrameSystemLimitsBlockWeights (224) */
  ...
  /** @name FrameSupportWeightsPerDispatchClassWeightsPerClass (225) */
  ...
  /** @name FrameSystemLimitsWeightsPerClass (226) */
  ...
  /** @name FrameSupportWeightsPerDispatchClassU32 (228) */
  ...
  /** @name FrameSupportWeightsRuntimeDbWeight (229) */
  ...
  /** @name SpConsensusSlotsEquivocationProof (241) */
  ...
  /** @name SpRuntimeBlakeTwo256 (243) */
  export type SpRuntimeBlakeTwo256 = Null;

  /** @name SpConsensusBabeAppPublic (244) */
  ...
  /** @name SpConsensusBabeDigestsNextConfigDescriptor (247) */
  ...
  /** @name SpConsensusBabeAllowedSlots (248) */
  ...
  /** @name JoystreamNodeRuntimeNposSolution16 (256) */
  ...
  /** @name SpNposElectionsElectionScore (307) */
  ...
  /** @name PalletStakingPalletCall (315) */
  ...
  /** @name PalletStakingRewardDestination (316) */
  ...
  /** @name PalletStakingPalletConfigOpU128 (320) */
  ...
  /** @name PalletStakingPalletConfigOpU32 (321) */
  ...
  /** @name PalletStakingPalletConfigOpPercent (322) */
  ...
  /** @name PalletStakingPalletConfigOpPerbill (323) */
  ...
  /** @name JoystreamNodeRuntimeSessionKeys (325) */
  ...
  /** @name PalletImOnlineHeartbeat (340) */
  ...
  /** @name SpCoreOffchainOpaqueNetworkState (341) */
  ...
  /** @name PalletVestingVestingInfo (350) */
  ...
  /** @name PalletConstitutionCall (355) */
  ...
  /** @name PalletContentPullPaymentElement (361) */
  ...
  /** @name PalletContentInitTransferParameters (362) */
  ...
  /** @name PalletProjectTokenTokenSaleParams (363) */
  ...
  /** @name PalletStorageDynBagCreationParametersRecord (369) */
  ...
  /** @name PalletProjectTokenCall (370) */
  ...
  /** @name PalletProposalsEngineCall (380) */
  ...
  /** @name PalletProposalsDiscussionCall (381) */
  ...
  /** @name PalletProposalsCodexCall (382) */
  ...
  /** @name PalletWorkingGroupCall (383) */
  ...
  /** @name JoystreamNodeRuntimeOriginCaller (392) */
  ...
  /** @name PalletUtilityError (395) */
  export interface PalletUtilityError extends Enum {
    readonly isTooManyCalls: boolean;
    readonly type: 'TooManyCalls';
  }

  /** @name SpConsensusBabeDigestsPreDigest (402) */
  ...
  /** @name SpConsensusBabeDigestsPrimaryPreDigest (403) */
  ...
  /** @name SpConsensusBabeDigestsSecondaryPlainPreDigest (404) */
  export interface SpConsensusBabeDigestsSecondaryPlainPreDigest extends Struct {
    readonly authorityIndex: u32;
    readonly slot: u64;
  }

  /** @name SpConsensusBabeDigestsSecondaryVRFPreDigest (405) */
  ...
  /** @name SpConsensusBabeBabeEpochConfiguration (407) */
  export interface SpConsensusBabeBabeEpochConfiguration extends Struct {
    readonly c: ITuple<[u64, u64]>;
    readonly allowedSlots: SpConsensusBabeAllowedSlots;
  }

  /** @name PalletBabeError (408) */
  ...
  /** @name PalletAuthorshipUncleEntryItem (410) */
  ...
  /** @name PalletAuthorshipError (411) */
  ...
  /** @name PalletBalancesBalanceLock (413) */
  ...
  /** @name PalletBalancesReasons (414) */
  ...
  /** @name PalletBalancesReserveData (417) */
  export interface PalletBalancesReserveData extends Struct {
    readonly id: U8aFixed;
    readonly amount: u128;
  }

  /** @name PalletBalancesReleases (419) */
  ...
  /** @name PalletElectionProviderMultiPhasePhase (423) */
  ...
  /** @name PalletElectionProviderMultiPhaseReadySolution (425) */
  ...
  /** @name PalletElectionProviderMultiPhaseRoundSnapshot (426) */
  export interface PalletElectionProviderMultiPhaseRoundSnapshot extends Struct {
    readonly voters: Vec<ITuple<[AccountId32, u64, Vec<AccountId32>]>>;
    readonly targets: Vec<AccountId32>;
  }

  /** @name PalletElectionProviderMultiPhaseSignedSignedSubmission (434) */
  ...
  /** @name PalletElectionProviderMultiPhaseError (435) */
  ...
  /** @name PalletStakingStakingLedger (436) */
  ...
  /** @name PalletStakingUnlockChunk (438) */
  export interface PalletStakingUnlockChunk extends Struct {
    readonly value: Compact<u128>;
    readonly era: Compact<u32>;
  }

  /** @name PalletStakingNominations (440) */
  ...
  /** @name PalletStakingUnappliedSlash (449) */
  ...
  /** @name PalletStakingSlashingSlashingSpans (451) */
  ...
  /** @name PalletStakingPalletError (456) */
  ...
  /** @name SpCoreCryptoKeyTypeId (460) */
  export interface SpCoreCryptoKeyTypeId extends U8aFixed {}

  /** @name PalletSessionError (461) */
  ...
  /** @name PalletGrandpaStoredState (463) */
  ...
  /** @name PalletGrandpaStoredPendingChange (464) */
  ...
  /** @name PalletImOnlineBoundedOpaqueNetworkState (472) */
  export interface PalletImOnlineBoundedOpaqueNetworkState extends Struct {
    readonly peerId: Bytes;
    readonly externalAddresses: Vec<Bytes>;
  }

  /** @name PalletImOnlineError (476) */
  ...
  /** @name SpStakingOffenceOffenceDetails (477) */
  ...
  /** @name PalletBagsListListNode (481) */
  ...
  /** @name PalletBagsListListListError (484) */
  ...
  /** @name PalletCouncilCouncilStageUpdate (489) */
  ...
  /** @name PalletCouncilCouncilStage (490) */
  ...
  /** @name PalletCouncilCandidate (495) */
  ...
  /** @name PalletReferendumReferendumStage (497) */
  ...
  /** @name PalletReferendumReferendumStageVoting (498) */
  ...
  /** @name PalletReferendumReferendumStageRevealing (499) */
  ...
  /** @name PalletReferendumCastVote (500) */
  ...
  /** @name PalletReferendumError (501) */
  ...
  /** @name PalletMembershipMembershipObject (502) */
  ...
  /** @name PalletMembershipStakingAccountMemberBinding (503) */
  ...
  /** @name PalletContentNftTypesOwnedNft (512) */
  ...
  /** @name PalletContentNftTypesTransactionalStatusRecord (513) */
  ...
  /** @name PalletContentNftTypesEnglishAuctionRecord (514) */
  ...
  /** @name PalletContentNftTypesEnglishAuctionBid (516) */
  export interface PalletContentNftTypesEnglishAuctionBid extends Struct {
    readonly amount: u128;
    readonly bidderId: u64;
  }

  /** @name PalletContentNftTypesOpenAuctionRecord (517) */
  ...
  /** @name PalletContentNftTypesNftOwner (518) */
  ...
  /** @name PalletContentPermissionsCuratorGroup (520) */
  ...
  /** @name PalletContentNftTypesOpenAuctionBidRecord (521) */
  ...
  /** @name PalletContentErrorsError (522) */
  ...
  /** @name PalletStorageBagRecord (523) */
  ...
  /** @name PalletStorageStorageBucketRecord (524) */
  ...
  /** @name PalletStorageStorageBucketOperatorStatus (525) */
  ...
  /** @name PalletStorageDynamicBagCreationPolicy (526) */
  export interface PalletStorageDynamicBagCreationPolicy extends Struct {
    readonly numberOfStorageBuckets: u64;
    readonly families: BTreeMap<u64, u32>;
  }

  /** @name PalletStorageDataObject (528) */
  ...
  /** @name PalletProjectTokenAccountData (533) */
  ...
  /** @name PalletProjectTokenVestingSchedule (534) */
  ...
  /** @name PalletProjectTokenRevenueSplitState (543) */
  ...
  /** @name PalletProjectTokenRevenueSplitInfo (544) */
  ...
  /** @name PalletProjectTokenTimeline (545) */
  export interface PalletProjectTokenTimeline extends Struct {
    readonly start: u32;
    readonly duration: u32;
  }

  /** @name PalletProjectTokenPatronageData (547) */
  ...
  /** @name PalletProjectTokenErrorsError (549) */
  ...
  /** @name PalletProposalsEngineProposal (550) */
  ...
  /** @name PalletProposalsEngineProposalParameters (551) */
  ...
  /** @name PalletProposalsEngineVotingResults (552) */
  ...
  /** @name PalletProposalsEngineError (554) */
  ...
  /** @name PalletProposalsDiscussionDiscussionThread (555) */
  ...
  /** @name PalletProposalsDiscussionDiscussionPost (556) */
  ...
  /** @name PalletProposalsDiscussionError (557) */
  ...
  /** @name PalletProposalsCodexError (558) */
  ...
  /** @name PalletWorkingGroupOpening (559) */
  ...
  /** @name PalletWorkingGroupJobApplication (560) */
  ...
  /** @name PalletWorkingGroupGroupWorker (561) */
  ...
  /** @name PalletWorkingGroupErrorsError (562) */
  ...
  /** @name JoystreamNodeRuntimeRuntime (585) */
