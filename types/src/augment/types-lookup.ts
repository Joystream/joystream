...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletForumPrivilegedActor (77) */
  ...
  /** @name PalletForumExtendedPostIdObject (78) */
  ...
  /** @name PalletConstitutionRawEvent (83) */
  ...
  /** @name PalletBountyBountyParametersBTreeSet (85) */
  ...
  /** @name PalletBountyAssuranceContractTypeBTreeSet (87) */
  ...
  /** @name PalletBountyFundingType (88) */
  ...
  /** @name PalletBountyOracleWorkEntryJudgment (90) */
  ...
  /** @name PalletCommonWorkingGroupIterableEnumsWorkingGroup (94) */
  ...
  /** @name PalletCommonBalanceKind (95) */
  ...
  /** @name PalletContentPermissionsContentActor (97) */
  ...
  /** @name PalletContentChannelRecord (98) */
  ...
  /** @name PalletContentIterableEnumsChannelActionPermission (102) */
  ...
  /** @name PalletContentPermissionsCuratorGroupIterableEnumsPausableChannelFeature (109) */
  ...
  /** @name PalletContentChannelTransferStatus (114) */
  ...
  /** @name PalletContentPendingTransfer (115) */
  ...
  /** @name PalletContentTransferCommitmentParametersBoundedBTreeMap (116) */
  ...
  /** @name PalletContentNftTypesOpenAuctionParamsRecord (121) */
  ...
  /** @name PalletContentNftTypesNftIssuanceParametersRecord (122) */
  ...
  /** @name PalletContentNftTypesInitTransactionalStatusRecord (123) */
  ...
  /** @name PalletContentChannelCreationParametersRecord (125) */
  ...
  /** @name PalletContentStorageAssetsRecord (126) */
  ...
  /** @name PalletContentChannelUpdateParametersRecord (136) */
  ...
  /** @name PalletContentVideoCreationParametersRecord (138) */
  ...
  /** @name PalletContentVideoUpdateParametersRecord (140) */
  ...
  /** @name PalletContentPermissionsCuratorGroupIterableEnumsContentModerationAction (143) */
  ...
  /** @name PalletContentTransferCommitmentParametersBTreeMap (147) */
  ...
  /** @name PalletContentUpdateChannelPayoutsParametersRecord (148) */
  ...
  /** @name PalletContentChannelPayoutsPayloadParametersRecord (149) */
  ...
  /** @name PalletContentChannelFundsDestination (153) */
  ...
  /** @name PalletContentNftLimitPeriod (154) */
  ...
  /** @name PalletStorageRawEvent (155) */
  ...
  /** @name PalletStorageUploadParametersRecord (156) */
  ...
  /** @name PalletStorageBagIdType (157) */
  ...
  /** @name PalletStorageStaticBagId (158) */
  ...
  /** @name PalletStorageDynamicBagIdType (159) */
  ...
  /** @name PalletStorageDynBagCreationParametersRecord (160) */
  ...
  /** @name PalletStorageDynamicBagType (164) */
  ...
  /** @name PalletProjectTokenEventsRawEvent (168) */
  ...
  /** @name PalletProjectTokenTransferPolicy (169) */
  ...
  /** @name PalletProjectTokenTokenIssuanceParameters (170) */
  ...
  /** @name PalletProjectTokenTokenAllocation (171) */
  ...
  /** @name PalletProjectTokenVestingScheduleParams (172) */
  ...
  /** @name PalletProjectTokenTransferPolicyParams (175) */
  ...
  /** @name PalletProjectTokenWhitelistParams (176) */
  ...
  /** @name PalletProjectTokenSingleDataObjectUploadParams (177) */
  ...
  /** @name PalletProjectTokenValidated (184) */
  ...
  /** @name PalletProjectTokenValidatedPayment (185) */
  ...
  /** @name PalletProjectTokenPaymentWithVesting (186) */
  ...
  /** @name PalletProjectTokenVestingSource (188) */
  ...
  /** @name PalletProjectTokenTokenSale (192) */
  ...
  /** @name PalletProposalsEngineRawEvent (194) */
  ...
  /** @name PalletProposalsEngineProposalStatusesProposalStatus (195) */
  ...
  /** @name PalletProposalsEngineProposalStatusesProposalDecision (196) */
  ...
  /** @name PalletProposalsEngineProposalStatusesApprovedProposalDecision (197) */
  ...
  /** @name PalletProposalsEngineProposalStatusesExecutionStatus (198) */
  ...
  /** @name PalletProposalsEngineVoteKind (199) */
  ...
  /** @name PalletProposalsDiscussionRawEvent (200) */
  ...
  /** @name PalletProposalsDiscussionThreadModeBTreeSet (201) */
  ...
  /** @name PalletProposalsCodexRawEvent (202) */
  ...
  /** @name PalletProposalsCodexGeneralProposalParams (203) */
  ...
  /** @name PalletProposalsCodexProposalDetails (204) */
  ...
  /** @name PalletCommonFundingRequestParameters (206) */
  export interface PalletCommonFundingRequestParameters extends Struct {
    readonly account: AccountId32;
    readonly amount: u128;
  }

  /** @name PalletProposalsCodexCreateOpeningParameters (207) */
  ...
  /** @name PalletWorkingGroupStakePolicy (208) */
  ...
  /** @name PalletProposalsCodexFillOpeningParameters (209) */
  ...
  /** @name PalletProposalsCodexTerminateRoleParameters (210) */
  ...
  /** @name PalletWorkingGroupRawEventInstance1 (211) */
  ...
  /** @name PalletWorkingGroupOpeningType (215) */
  ...
  /** @name PalletWorkingGroupApplyOnOpeningParams (216) */
  ...
  /** @name PalletWorkingGroupRawEventInstance2 (220) */
  ...
  /** @name PalletWorkingGroupInstance2 (221) */
  export type PalletWorkingGroupInstance2 = Null;

  /** @name PalletWorkingGroupRawEventInstance3 (222) */
  ...
  /** @name PalletWorkingGroupInstance3 (223) */
  export type PalletWorkingGroupInstance3 = Null;

  /** @name PalletWorkingGroupRawEventInstance4 (224) */
  ...
  /** @name PalletWorkingGroupInstance4 (225) */
  export type PalletWorkingGroupInstance4 = Null;

  /** @name PalletWorkingGroupRawEventInstance5 (226) */
  ...
  /** @name PalletWorkingGroupInstance5 (227) */
  export type PalletWorkingGroupInstance5 = Null;

  /** @name PalletWorkingGroupRawEventInstance6 (228) */
  ...
  /** @name PalletWorkingGroupInstance6 (229) */
  export type PalletWorkingGroupInstance6 = Null;

  /** @name PalletWorkingGroupRawEventInstance7 (230) */
  ...
  /** @name PalletWorkingGroupInstance7 (231) */
  export type PalletWorkingGroupInstance7 = Null;

  /** @name PalletWorkingGroupRawEventInstance8 (232) */
  ...
  /** @name PalletWorkingGroupInstance8 (233) */
  export type PalletWorkingGroupInstance8 = Null;

  /** @name PalletWorkingGroupRawEventInstance9 (234) */
  ...
  /** @name PalletWorkingGroupInstance9 (235) */
  ...
  /** @name FrameSupportWeightsPerDispatchClassWeightsPerClass (247) */
  ...
  /** @name FrameSupportWeightsPerDispatchClassU32 (250) */
  ...
  /** @name FrameSupportWeightsRuntimeDbWeight (251) */
  ...
  /** @name SpConsensusSlotsEquivocationProof (263) */
  ...
  /** @name SpConsensusBabeDigestsNextConfigDescriptor (269) */
  ...
  /** @name PalletElectionProviderMultiPhaseCall (276) */
  ...
  /** @name JoystreamNodeRuntimeNposSolution16 (278) */
  ...
  /** @name SpNposElectionsElectionScore (329) */
  ...
  /** @name PalletStakingRewardDestination (338) */
  ...
  /** @name PalletStakingPalletConfigOpU128 (342) */
  ...
  /** @name PalletStakingPalletConfigOpU32 (343) */
  ...
  /** @name PalletStakingPalletConfigOpPercent (344) */
  ...
  /** @name PalletStakingPalletConfigOpPerbill (345) */
  ...
  /** @name JoystreamNodeRuntimeSessionKeys (347) */
  ...
  /** @name SpAuthorityDiscoveryAppPublic (348) */
  ...
  /** @name PalletImOnlineHeartbeat (362) */
  ...
  /** @name SpCoreOffchainOpaqueNetworkState (363) */
  export interface SpCoreOffchainOpaqueNetworkState extends Struct {
    readonly peerId: Bytes;
    readonly externalAddresses: Vec<Bytes>;
  }

  /** @name PalletImOnlineSr25519AppSr25519Signature (367) */
  ...
  /** @name PalletVestingVestingInfo (371) */
  ...
  /** @name PalletConstitutionCall (379) */
  ...
  /** @name PalletContentChannelBagWitness (383) */
  ...
  /** @name PalletContentPullPaymentElement (387) */
  ...
  /** @name PalletContentInitTransferParameters (388) */
  ...
  /** @name PalletProjectTokenTokenSaleParams (389) */
  ...
  /** @name PalletProjectTokenCall (395) */
  ...
  /** @name PalletProposalsEngineCall (405) */
  ...
  /** @name PalletProposalsDiscussionCall (406) */
  ...
  /** @name PalletProposalsCodexCall (407) */
  ...
  /** @name PalletWorkingGroupCall (408) */
  ...
  /** @name JoystreamNodeRuntimeOriginCaller (417) */
  ...
  /** @name FrameSupportDispatchRawOrigin (418) */
  ...
  /** @name PalletUtilityError (420) */
  export interface PalletUtilityError extends Enum {
    readonly isTooManyCalls: boolean;
    readonly type: 'TooManyCalls';
  }

  /** @name SpConsensusBabeDigestsPreDigest (427) */
  ...
  /** @name SpConsensusBabeDigestsPrimaryPreDigest (428) */
  ...
  /** @name SpConsensusBabeDigestsSecondaryPlainPreDigest (429) */
  export interface SpConsensusBabeDigestsSecondaryPlainPreDigest extends Struct {
    readonly authorityIndex: u32;
    readonly slot: u64;
  }

  /** @name SpConsensusBabeDigestsSecondaryVRFPreDigest (430) */
  ...
  /** @name SpConsensusBabeBabeEpochConfiguration (432) */
  export interface SpConsensusBabeBabeEpochConfiguration extends Struct {
    readonly c: ITuple<[u64, u64]>;
    readonly allowedSlots: SpConsensusBabeAllowedSlots;
  }

  /** @name PalletBabeError (433) */
  ...
  /** @name PalletAuthorshipError (436) */
  ...
  /** @name PalletBalancesReleases (444) */
  ...
  /** @name PalletElectionProviderMultiPhasePhase (448) */
  ...
  /** @name PalletElectionProviderMultiPhaseReadySolution (450) */
  ...
  /** @name PalletElectionProviderMultiPhaseSignedSignedSubmission (459) */
  ...
  /** @name PalletElectionProviderMultiPhaseError (460) */
  ...
  /** @name PalletStakingStakingLedger (461) */
  ...
  /** @name PalletStakingUnlockChunk (463) */
  ...
  /** @name PalletStakingReleases (480) */
  ...
  /** @name PalletStakingPalletError (481) */
  ...
  /** @name PalletBagsListListListError (508) */
  ...
  /** @name PalletVestingReleases (511) */
  ...
  /** @name PalletMultisigMultisig (514) */
  ...
  /** @name PalletCouncilCouncilStageUpdate (517) */
  ...
  /** @name PalletCouncilCouncilStage (518) */
  ...
  /** @name PalletCouncilCandidate (525) */
  ...
  /** @name PalletReferendumReferendumStage (527) */
  ...
  /** @name PalletReferendumReferendumStageVoting (529) */
  ...
  /** @name PalletReferendumReferendumStageRevealing (530) */
  ...
  /** @name PalletReferendumCastVote (531) */
  ...
  /** @name PalletReferendumError (532) */
  ...
  /** @name PalletMembershipMembershipObject (533) */
  ...
  /** @name PalletMembershipStakingAccountMemberBinding (534) */
  ...
  /** @name PalletConstitutionConstitutionInfo (541) */
  export interface PalletConstitutionConstitutionInfo extends Struct {
    readonly textHash: H256;
  }

  /** @name PalletBountyBountyRecord (542) */
  ...
  /** @name PalletBountyBountyParametersBoundedBTreeSet (544) */
  ...
  /** @name PalletBountyAssuranceContractTypeBoundedBTreeSet (545) */
  ...
  /** @name PalletBountyBountyMilestone (546) */
  ...
  /** @name PalletContentVideoRecord (552) */
  ...
  /** @name PalletContentNftTypesOwnedNft (553) */
  ...
  /** @name PalletContentNftTypesTransactionalStatusRecord (554) */
  ...
  /** @name PalletContentNftTypesEnglishAuctionRecord (555) */
  ...
  /** @name PalletContentNftTypesEnglishAuctionBid (558) */
  export interface PalletContentNftTypesEnglishAuctionBid extends Struct {
    readonly amount: u128;
    readonly bidderId: u64;
  }

  /** @name PalletContentNftTypesOpenAuctionRecord (559) */
  ...
  /** @name PalletContentNftTypesNftOwner (560) */
  ...
  /** @name PalletContentPermissionsCuratorGroupCuratorGroupRecord (563) */
  ...
  /** @name PalletContentNftTypesOpenAuctionBidRecord (570) */
  ...
  /** @name PalletContentErrorsError (571) */
  ...
  /** @name PalletStorageBagRecord (572) */
  ...
  /** @name PalletStorageStorageBucketRecord (575) */
  ...
  /** @name PalletStorageStorageBucketOperatorStatus (576) */
  ...
  /** @name PalletStorageDynamicBagCreationPolicy (578) */
  export interface PalletStorageDynamicBagCreationPolicy extends Struct {
    readonly numberOfStorageBuckets: u32;
    readonly families: BTreeMap<u64, u32>;
  }

  /** @name PalletStorageDataObject (581) */
  ...
  /** @name PalletProjectTokenAccountData (587) */
  ...
  /** @name PalletProjectTokenTokenData (597) */
  ...
  /** @name PalletProjectTokenRevenueSplitState (598) */
  ...
  /** @name PalletProjectTokenRevenueSplitInfo (599) */
  ...
  /** @name PalletProjectTokenTimeline (600) */
  export interface PalletProjectTokenTimeline extends Struct {
    readonly start: u32;
    readonly duration: u32;
  }

  /** @name PalletProjectTokenPatronageData (602) */
  ...
  /** @name PalletProjectTokenErrorsError (604) */
  ...
  /** @name PalletProposalsEngineProposal (605) */
  ...
  /** @name PalletProposalsEngineProposalParameters (606) */
  ...
  /** @name PalletProposalsEngineVotingResults (607) */
  ...
  /** @name PalletProposalsEngineError (610) */
  ...
  /** @name PalletProposalsDiscussionDiscussionThread (611) */
  ...
  /** @name PalletProposalsDiscussionThreadModeBoundedBTreeSet (613) */
  ...
  /** @name PalletProposalsDiscussionDiscussionPost (614) */
  ...
  /** @name PalletProposalsDiscussionError (615) */
  ...
  /** @name PalletProposalsCodexError (616) */
  ...
  /** @name PalletWorkingGroupOpening (617) */
  ...
  /** @name PalletWorkingGroupJobApplication (618) */
  ...
  /** @name PalletWorkingGroupGroupWorker (619) */
  ...
  /** @name PalletWorkingGroupErrorsError (620) */
  ...
  /** @name SpCoreEcdsaSignature (631) */
  export interface SpCoreEcdsaSignature extends U8aFixed {}

  /** @name FrameSystemExtensionsCheckNonZeroSender (634) */
  ...
  /** @name JoystreamNodeRuntimeRuntime (643) */
