...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletConstitutionEvent (84) */
  ...
  /** @name PalletCommonWorkingGroup (86) */
  ...
  /** @name PalletCommonBalanceKind (87) */
  ...
  /** @name PalletContentPermissionsContentActor (89) */
  ...
  /** @name PalletContentChannelRecord (90) */
  ...
  /** @name PalletContentNftTypesOpenAuctionParamsRecord (110) */
  ...
  /** @name PalletContentNftTypesNftIssuanceParametersRecord (111) */
  ...
  /** @name PalletContentNftTypesInitTransactionalStatusRecord (112) */
  ...
  /** @name PalletContentChannelCreationParametersRecord (114) */
  ...
  /** @name PalletContentStorageAssetsRecord (115) */
  ...
  /** @name PalletContentChannelUpdateParametersRecord (122) */
  ...
  /** @name PalletContentVideoCreationParametersRecord (124) */
  ...
  /** @name PalletContentVideoUpdateParametersRecord (126) */
  ...
  /** @name PalletContentPermissionsCuratorGroupContentModerationAction (129) */
  ...
  /** @name PalletContentUpdateChannelPayoutsParametersRecord (133) */
  ...
  /** @name PalletContentChannelPayoutsPayloadParametersRecord (134) */
  ...
  /** @name PalletContentChannelFundsDestination (138) */
  ...
  /** @name PalletStorageUploadParametersRecord (141) */
  ...
  /** @name PalletStorageDynBagCreationParametersRecord (377) */
  ...
  /** @name PalletForumPollAlternative (522) */
  ...
  /** @name PalletContentPermissionsCuratorGroup (536) */
  ...
  /** @name PalletContentNftTypesOpenAuctionBidRecord (537) */
  ...
  /** @name PalletContentErrorsError (538) */
  ...
  /** @name PalletStorageBagRecord (539) */
  ...
  /** @name PalletStorageStorageBucketRecord (540) */
  ...
  /** @name PalletStorageStorageBucketOperatorStatus (541) */
  ...
  /** @name PalletStorageDynamicBagCreationPolicy (542) */
  export interface PalletStorageDynamicBagCreationPolicy extends Struct {
    readonly numberOfStorageBuckets: u64;
    readonly families: BTreeMap<u64, u32>;
  }

  /** @name PalletStorageDataObject (544) */
  ...
  /** @name PalletProjectTokenAccountData (549) */
  ...
  /** @name PalletProjectTokenVestingSchedule (550) */
  ...
  /** @name PalletProjectTokenRevenueSplitState (559) */
  ...
  /** @name PalletProjectTokenRevenueSplitInfo (560) */
  ...
  /** @name PalletProjectTokenTimeline (561) */
  export interface PalletProjectTokenTimeline extends Struct {
    readonly start: u32;
    readonly duration: u32;
  }

  /** @name PalletProjectTokenPatronageData (563) */
  ...
  /** @name PalletProjectTokenErrorsError (565) */
  ...
  /** @name PalletProposalsEngineProposal (566) */
  ...
  /** @name PalletProposalsEngineProposalParameters (567) */
  ...
  /** @name PalletProposalsEngineVotingResults (568) */
  ...
  /** @name PalletProposalsEngineError (570) */
  ...
  /** @name PalletProposalsDiscussionDiscussionThread (571) */
  ...
  /** @name PalletProposalsDiscussionDiscussionPost (572) */
  ...
  /** @name PalletProposalsDiscussionError (573) */
  ...
  /** @name PalletProposalsCodexError (574) */
  ...
  /** @name PalletWorkingGroupOpening (575) */
  ...
  /** @name PalletWorkingGroupJobApplication (576) */
  ...
  /** @name PalletWorkingGroupGroupWorker (577) */
  ...
  /** @name PalletWorkingGroupErrorsError (578) */
  ...
  /** @name SpRuntimeMultiSignature (588) */
  ...
  /** @name JoystreamNodeRuntimeRuntime (601) */
