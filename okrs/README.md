...
| Date     | KR #1 | KR #2 | KR #3 | KR #4 | KR #5 |Comments|
|:--------:|:-----:|:-----:|:-----:|:-----:|:-----:|:------:|
| 23.04.19 |(31) **0.06**  |  (182,318) **0**   | (30,5) **0.01** | **0.25** |   0  | Changed #1 from `ewd` to `n`  |
| 07.05.19 |(35) **0.07**  |  (344,552) **0**   | (46,12) **0.01**    |  **0.35**   |   **0.1**  | -|
| 21.05.19 |(43) **0.09**  |  (478,778) **0.**  | (143,21.5) **0.01** | **0.5** | **0.1** | -   |
| 04.06.19 |       |       |       |       |       | **NA** |
| 18.06.19 |       |       |       |       |       | **NA** |
| 02.07.19 |       |       |       |       |       | **NA** |
...
| 20.05.19 |(0.6,0.8) **0.7**|(0.4,1,*0.1*) **0.4**|(*0*,0.1) **0.03**|(*0*,0,0,0) **0**|(0.5,*1*,0.5,0.25,0.95) **0.59**|  *n* denotes Jens' tracking (absent)|
| 27.05.19 |       |       |       |       |       |     **NA**        |
| 03.06.19 |       |       |       |       |       |     **NA**        |
| 10.06.19 |       |       |       |       |       |     **NA**        |
| 17.06.19 |       |       |       |       |       |     **NA**        |
