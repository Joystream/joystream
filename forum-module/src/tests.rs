...
//         generate_old_forum_data(forum_sudo, 1, 1, 1, 10);
//         generate_old_forum_data(forum_sudo, 1, 10, 10, 10);
//         for index in 0..4 {
...
//             generate_old_forum_data(forum_sudo, 1, 1, 100_000, *text_size as usize);
//             for index in 0..4 {
//                 assert_eq!(TestForumModule::data_migration_done(), false);
//                 let start = Instant::now();
//                 on_initialize_mock(index);
...
//             Ok(()),
//         );
//         TestForumModule::clear_category();
//         assert_eq!(
//             TestForumModule::category_by_id(category_id),
//             Default::default()
//         );
//     });
// }
